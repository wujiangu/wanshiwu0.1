...
public class CFileManager
{
    ...
    static CFileManager()
    {
        ...
        {
            <>f__am$cache5 = new DelegateOnOperateFileFail(CFileManager.<s_delegateOnOperateFileFail>m__41);
        }
        s_delegateOnOperateFileFail = <>f__am$cache5;
    }

    [CompilerGenerated]
    private static void <s_delegateOnOperateFileFail>m__41(string, enFileOperation)
    {
    }
