namespace Pathfinding
{
    ...
    public class AstarData
    {
        ...
        public void DeserializeGraphsPart(AstarSerializer sr)
        {
            ...
            <DeserializeGraphsPart>c__AnonStorey18 storey = new <DeserializeGraphsPart>c__AnonStorey18 {
                i = 0
            };
        ...
        public void DeserializeGraphsPartAdditive(AstarSerializer sr)
        {
            ...
            <DeserializeGraphsPartAdditive>c__AnonStorey19 storey = new <DeserializeGraphsPartAdditive>c__AnonStorey19 {
                i = 0
            };
            while (storey.i < this.graphs.Length)
            {
                if (this.graphs[storey.i] != null)
                {
                    this.graphs[storey.i].GetNodes(new GraphNodeDelegateCancelable(storey.<>m__8));
                }
                storey.i++;
            }
            sr.DeserializeExtraInfo();
        ...
        {
            <RasterizeGraphNodesInternal>c__AnonStorey17 storey = new <RasterizeGraphNodesInternal>c__AnonStorey17 {
                <>f__this = this
            };
            ...
            if ((this.graphs != null) && (this.graphs.Length != 0))
            {
                ...
                this.rasterizer = new GraphNodeRasterizer();
                this.rasterizer.Init(storey.min, storey.max.x - storey.min.x, storey.max.y - storey.min.y);
                for (int j = 0; j < this.graphs.Length; j++)
                {
        ...
        [CompilerGenerated]
        private sealed class <DeserializeGraphsPart>c__AnonStorey18
        {
            internal int i;
        ...
        [CompilerGenerated]
        private sealed class <DeserializeGraphsPartAdditive>c__AnonStorey19
        {
            internal int i;
        ...
        [CompilerGenerated]
        private sealed class <RasterizeGraphNodesInternal>c__AnonStorey17
        {
            internal AstarData <>f__this;
            internal VInt2 max;
            internal VInt2 min;
            ...
            internal bool <>m__6(GraphNode node)
            {
                ...
                if (data != null)
                {
                    ...
                    this.<>f__this.rasterizer.AddTriangle(ref xz, ref num2, ref num3, data);
                }
                return true;
            }
        }
