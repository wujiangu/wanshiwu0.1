namespace Pathfinding
{
    ...
    public class EuclideanEmbedding
    {
        ...
        {
            <RecalculatePivots>c__AnonStorey34 storey = new <RecalculatePivots>c__AnonStorey34 {
                <>f__this = this
            };
            if (this.mode == HeuristicOptimizationMode.None)
            {
            ...
            else
            {
                ...
                {
                    <RecalculatePivots>c__AnonStorey33 storey2 = new <RecalculatePivots>c__AnonStorey33 {
                        <>f__ref$52 = storey,
                        <>f__this = this,
                        n = 0
                    };
                ...
                else
                {
                    ...
                    <RecalculatePivots>c__AnonStorey35 storey3 = new <RecalculatePivots>c__AnonStorey35 {
                        first = null
                    };
                    if (this.pivotPointRoot != null)
                    {
        ...
        private sealed class <RecalculateCosts>c__AnonStorey38
        {
            ...
            {
                <RecalculateCosts>c__AnonStorey36 storey;
                storey = new <RecalculateCosts>c__AnonStorey36 {
                    <>f__ref$56 = this,
                    k = k,
            ...
            private sealed class <RecalculateCosts>c__AnonStorey36
            {
                internal EuclideanEmbedding.<RecalculateCosts>c__AnonStorey38 <>f__ref$56;
                ...
                {
                    <RecalculateCosts>c__AnonStorey37 storey = new <RecalculateCosts>c__AnonStorey37 {
                        <>f__ref$56 = this.<>f__ref$56,
                        <>f__ref$54 = this
                    };
                    _p.Claim(this.<>f__ref$56.<>f__this);
                    ...
                    if ((this.<>f__ref$56.<>f__this.mode == HeuristicOptimizationMode.RandomSpreadOut) && (this.k < (this.<>f__ref$56.<>f__this.pivots.Length - 1)))
                    {
                        int nodeIndex = -1;
                        uint num4 = 0;
                        int num5 = this.<>f__ref$56.<>f__this.maxNodeIndex / this.<>f__ref$56.<>f__this.pivotCount;
                        for (int k = 1; k < num5; k++)
                        {
                            uint num7 = 0x40000000;
                            for (int m = 0; m <= this.k; m++)
                            {
                                num7 = Math.Min(num7, this.<>f__ref$56.<>f__this.costs[(k * this.<>f__ref$56.<>f__this.pivotCount) + m]);
                            }
                        ...
                        this.<>f__ref$56.<>f__this.pivots[this.k + 1] = this.fp.pathHandler.GetPathNode(nodeIndex).node;
                        Debug.Log(string.Concat(new object[] { "Found node at ", this.<>f__ref$56.<>f__this.pivots[this.k + 1].position, " with score ", num4 }));
                        this.<>f__ref$56.startCostCalculation(this.k + 1);
                    }
                    _p.Release(this.<>f__ref$56.<>f__this);
                }

                private sealed class <RecalculateCosts>c__AnonStorey37
                {
                    internal EuclideanEmbedding.<RecalculateCosts>c__AnonStorey38.<RecalculateCosts>c__AnonStorey36 <>f__ref$54;
                    internal EuclideanEmbedding.<RecalculateCosts>c__AnonStorey38 <>f__ref$56;
                    internal uint costOffset;

                    internal bool <>m__2C(GraphNode node)
                    {
                        int index = (node.NodeIndex * this.<>f__ref$56.<>f__this.pivotCount) + this.<>f__ref$54.k;
                        this.<>f__ref$56.<>f__this.EnsureCapacity(index);
                        PathNode pathNode = this.<>f__ref$54.fp.pathHandler.GetPathNode(node);
                        if (this.costOffset > 0)
                        {
                            this.<>f__ref$56.<>f__this.costs[index] = ((pathNode.pathID != this.<>f__ref$54.fp.pathID) || (pathNode.parent == null)) ? 0 : Math.Max((uint) (pathNode.parent.G - this.costOffset), (uint) 0);
                        }
                        else
                        {
                            this.<>f__ref$56.<>f__this.costs[index] = (pathNode.pathID != this.<>f__ref$54.fp.pathID) ? 0 : pathNode.G;
                        }
                        return true;
                    }
                }
        ...
        [CompilerGenerated]
        private sealed class <RecalculatePivots>c__AnonStorey33
        {
            internal EuclideanEmbedding.<RecalculatePivots>c__AnonStorey34 <>f__ref$52;
            internal EuclideanEmbedding <>f__this;
            internal int n;
            ...
            internal bool <>m__28(GraphNode node)
            {
                if (!node.Destroyed && node.Walkable)
                {
                    ...
                    {
                        if (this.<>f__ref$52.pivotList.Count < this.<>f__this.spreadOutCount)
                        {
                            this.<>f__ref$52.pivotList.Add(node);
                        }
                        else
                        {
                            this.<>f__ref$52.pivotList[(int) (((ulong) this.<>f__this.GetRandom()) % ((long) this.<>f__ref$52.pivotList.Count))] = node;
                        }
                    }
                }
                return true;
