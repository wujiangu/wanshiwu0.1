namespace Pathfinding
{
    ...
    public abstract class GraphNode
    {
        ...
        {
            <ContainsConnection>c__AnonStorey21 storey = new <ContainsConnection>c__AnonStorey21 {
                node = node,
                contains = false
            };
        ...
        {
            <FloodFill>c__AnonStorey20 storey = new <FloodFill>c__AnonStorey20 {
                region = region,
                stack = stack
            };
        ...
        {
            <UpdateRecursiveG>c__AnonStorey1F storeyf = new <UpdateRecursiveG>c__AnonStorey1F {
                handler = handler,
                pathNode = pathNode,
                path = path
            };
            this.UpdateG(storeyf.path, storeyf.pathNode);
            storeyf.handler.PushNode(storeyf.pathNode);
            this.GetConnections(new GraphNodeDelegate(storeyf.<>m__12));
        }
        ...
        [CompilerGenerated]
        private sealed class <ContainsConnection>c__AnonStorey21
        {
        ...
        [CompilerGenerated]
        private sealed class <FloodFill>c__AnonStorey20
        {
        ...
        [CompilerGenerated]
        private sealed class <UpdateRecursiveG>c__AnonStorey1F
        {
