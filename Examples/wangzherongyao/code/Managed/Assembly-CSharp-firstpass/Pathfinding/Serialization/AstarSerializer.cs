namespace Pathfinding.Serialization
{
    ...
    public class AstarSerializer
    {
        ...
        {
            <DeserializeExtraInfo>c__AnonStorey28 storey = new <DeserializeExtraInfo>c__AnonStorey28();
            bool flag = false;
            ...
            if (flag)
            {
                ...
                <DeserializeExtraInfo>c__AnonStorey29 storey2 = new <DeserializeExtraInfo>c__AnonStorey29();
                ...
                storey2.reader = new BinaryReader(stream2);
                int num3 = storey2.reader.ReadInt32();
                storey2.int2Node = new GraphNode[num3 + 1];
                try
                {
                    for (int m = 0; m < this.graphs.Length; m++)
                    {
                        ...
                        {
                            this.graphs[m].GetNodes(new GraphNodeDelegateCancelable(storey2.<>m__1C));
                        }
                    }
                }
                ...
                for (int k = 0; k < this.graphs.Length; k++)
                {
                    ...
                    if (this.graphs[k] != null)
                    {
                        ...
                        stream2.Seek(0L, SeekOrigin.Begin);
                        storey2.reader = new BinaryReader(stream2);
                        storeya.ctx = new GraphSerializationContext(storey2.reader, storey2.int2Node, k);
                        this.graphs[k].GetNodes(new GraphNodeDelegateCancelable(storeya.<>m__1D));
                    }
                }
            }
        }
        ...
        {
            <SerializeExtraInfo>c__AnonStorey25 storey = new <SerializeExtraInfo>c__AnonStorey25();
            if (this.settings.nodes)
            {
                ...
                <SerializeExtraInfo>c__AnonStorey26 storey2 = new <SerializeExtraInfo>c__AnonStorey26();
                MemoryStream output = new MemoryStream();
                ...
                for (int k = 0; k < this.graphs.Length; k++)
                {
                    <SerializeExtraInfo>c__AnonStorey27 storey3 = new <SerializeExtraInfo>c__AnonStorey27();
                    if (this.graphs[k] != null)
                    {
                        MemoryStream stream2 = new MemoryStream();
        ...
        {
            <SerializeExtraInfoBytes>c__AnonStorey22 storey = new <SerializeExtraInfoBytes>c__AnonStorey22();
            if (!this.settings.nodes)
            {
                return null;
            }
            ...
            <SerializeExtraInfoBytes>c__AnonStorey23 storey2 = new <SerializeExtraInfoBytes>c__AnonStorey23 {
                <>f__ref$34 = storey
            };
            ...
            for (int k = 0; k < this.graphs.Length; k++)
            {
                <SerializeExtraInfoBytes>c__AnonStorey24 storey3 = new <SerializeExtraInfoBytes>c__AnonStorey24();
                if (this.graphs[k] != null)
                {
        ...
        [CompilerGenerated]
        private sealed class <DeserializeExtraInfo>c__AnonStorey28
        {
        ...
        [CompilerGenerated]
        private sealed class <SerializeExtraInfo>c__AnonStorey25
        {
            internal int totCount;
        ...
        [CompilerGenerated]
        private sealed class <SerializeExtraInfoBytes>c__AnonStorey22
        {
            internal int totCount;
            internal BinaryWriter wr;
        ...
        {
            internal AstarSerializer.<SerializeExtraInfoBytes>c__AnonStorey22 <>f__ref$34;
            internal int c;

            internal bool <>m__16(GraphNode node)
            {
                this.c = Math.Max(node.NodeIndex, this.c);
                this.<>f__ref$34.wr.Write(node.NodeIndex);
                return true;
            }
        }
