namespace Pathfinding
{
    ...
    public class RecastGraph : NavGraph, IUpdatableGraph, IRaycastableGraph, INavmesh, INavmeshHolder
    {
        ...
        {
            <OnDrawGizmos>c__AnonStorey32 storey = new <OnDrawGizmos>c__AnonStorey32 {
                <>f__this = this
            };
            if (drawNodes)
            {
        ...
        {
            <ScanAllTiles>c__AnonStorey31 storey = new <ScanAllTiles>c__AnonStorey31();
        ...
        [CompilerGenerated]
        private sealed class <OnDrawGizmos>c__AnonStorey32
        {
        ...
        [CompilerGenerated]
        private sealed class <ScanAllTiles>c__AnonStorey31
        {
