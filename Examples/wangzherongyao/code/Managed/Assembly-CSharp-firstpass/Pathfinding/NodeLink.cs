namespace Pathfinding
{
    ...
    public class NodeLink : GraphModifier
    {
        ...
        public override void OnGraphsPostUpdate()
        {
            ...
            {
                AstarPath.active.AddWorkItem(new AstarPath.AstarWorkItem(new Func<bool, bool>(this, (IntPtr) this.<OnGraphsPostUpdate>m__11)));
            }
        }
        ...
        public override void OnPostScan()
        {
            ...
            {
                AstarPath.active.AddWorkItem(new AstarPath.AstarWorkItem(new Func<bool, bool>(this, (IntPtr) this.<OnPostScan>m__10)));
            }
        }
