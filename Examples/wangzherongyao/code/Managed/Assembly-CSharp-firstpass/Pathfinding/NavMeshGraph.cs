namespace Pathfinding
{
    ...
    public class NavMeshGraph : NavGraph, IUpdatableGraph, IRaycastableGraph, INavmesh, INavmeshHolder
    {
        ...
        {
            <GetNearestForceBoth>c__AnonStorey2F storeyf;
            storeyf = new <GetNearestForceBoth>c__AnonStorey2F {
                accurateNearestNode = accurateNearestNode,
                position = position,
                constraint = constraint,
                pos = (VInt3) storeyf.position,
                minDist = -1.0,
                minNode = null,
                minConstDist = -1.0,
                minConstNode = null,
                maxDistSqr = !storeyf.constraint.constrainDistance ? float.PositiveInfinity : AstarPath.active.maxNearestNodeDistanceSqr
            };
            GraphNodeDelegateCancelable del = new GraphNodeDelegateCancelable(storeyf.<>m__24);
            graph.GetNodes(del);
            NNInfo info = new NNInfo(storeyf.minNode);
            if (info.node != null)
            {
                Vector3 vector = (info.node as TriangleMeshNode).ClosestPointOnNode(storeyf.position);
                info.clampedPosition = vector;
            }
            info.constrainedNode = storeyf.minConstNode;
            if (info.constrainedNode != null)
            {
                Vector3 vector2 = (info.constrainedNode as TriangleMeshNode).ClosestPointOnNode(storeyf.position);
        ...
        {
            <UpdateArea>c__AnonStorey30 storey = new <UpdateArea>c__AnonStorey30 {
                o = o
            };
        ...
        [CompilerGenerated]
        private sealed class <GetNearestForceBoth>c__AnonStorey2F
        {
        ...
        [CompilerGenerated]
        private sealed class <UpdateArea>c__AnonStorey30
        {
            internal VInt3 a;
            internal VInt3 b;
            internal VInt3 c;
