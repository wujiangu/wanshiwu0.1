...
public class NgInterpolate
{
    ...
    private sealed class <NewBezier>c__IteratorB<T> : IDisposable, IEnumerable, IEnumerator, IEnumerable<Vector3>, IEnumerator<Vector3>
    {
        ...
        internal IEnumerator<float> <$s_128>__1;
        internal int <i>__3;
        ...
        public void Dispose()
        {
            ...
            switch (num)
            {
                case 1:
                    ...
                    {
                        if (this.<$s_128>__1 == null)
                        {
                        }
                        this.<$s_128>__1.Dispose();
                    }
                    break;
            }
        }
        ...
        public bool MoveNext()
        {
            ...
            switch (num)
            {
                case 0:
                    ...
                    this.<$s_128>__1 = this.steps.GetEnumerator();
                    num = 0xfffffffd;
                    break;
            ...
            try
            {
                while (this.<$s_128>__1.MoveNext())
                {
                    this.<step>__2 = this.<$s_128>__1.Current;
                    this.<i>__3 = 0;
    ...
    private sealed class <NewEase>c__IteratorA : IDisposable, IEnumerator, IEnumerator<object>
    {
        ...
        internal IEnumerator<float> <$s_127>__1;
        ...
        public void Dispose()
        {
            ...
            switch (num)
            {
                case 1:
                    ...
                    {
                        if (this.<$s_127>__1 == null)
                        {
                        }
                        this.<$s_127>__1.Dispose();
                    }
                    break;
            }
        }
        ...
        public bool MoveNext()
        {
            ...
            switch (num)
            {
                case 0:
                    ...
                    this.<$s_127>__1 = this.driver.GetEnumerator();
                    num = 0xfffffffd;
                    break;
            ...
            try
            {
                while (this.<$s_127>__1.MoveNext())
                {
                    this.<i>__2 = this.<$s_127>__1.Current;
