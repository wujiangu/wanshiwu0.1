namespace CSProtocol
{
    ...
    {
        public COMDT_CHAT_MSG_HORN[] astMsgInfo = new COMDT_CHAT_MSG_HORN[100];
        public static readonly uint BASEVERSION = 1;
        public byte bHornType;
        public static readonly int CLASS_ID = 0x315;
        public static readonly uint CURRVERSION = 1;
        public uint dwBeginMsgIdx;
        public uint dwBeginShowTime;
        public ushort wMsgCnt;
        public ushort wTotalMsgCnt;
        ...
        {
            this.bHornType = 0;
            this.dwBeginShowTime = 0;
            this.dwBeginMsgIdx = 0;
            this.wTotalMsgCnt = 0;
            this.wMsgCnt = 0;
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            {
                type = destBuf.writeUInt32(this.dwBeginShowTime);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
                type = destBuf.writeUInt32(this.dwBeginMsgIdx);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
                type = destBuf.writeUInt16(this.wTotalMsgCnt);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                type = srcBuf.readUInt32(ref this.dwBeginShowTime);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
                type = srcBuf.readUInt32(ref this.dwBeginMsgIdx);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
                type = srcBuf.readUInt16(ref this.wTotalMsgCnt);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
