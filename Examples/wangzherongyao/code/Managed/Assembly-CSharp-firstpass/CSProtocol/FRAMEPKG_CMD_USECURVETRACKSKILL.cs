namespace CSProtocol
{
    ...
    public class FRAMEPKG_CMD_USECURVETRACKSKILL : ProtocolObject
    {
        ...
        public int iSkillID;
        public FRAMEDT_VECTOR3 stBegin = ((FRAMEDT_VECTOR3) ProtocolObjectPool.Get(FRAMEDT_VECTOR3.CLASS_ID));
        public FRAMEDT_VECTOR3 stEnd = ((FRAMEDT_VECTOR3) ProtocolObjectPool.Get(FRAMEDT_VECTOR3.CLASS_ID));
        ...
        public override TdrError.ErrorType pack(ref TdrWriteBuf destBuf, uint cutVer)
        {
            ...
            type = this.stBegin.pack(ref destBuf, cutVer);
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                type = this.stEnd.pack(ref destBuf, cutVer);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
        ...
        public override TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            type = this.stBegin.unpack(ref srcBuf, cutVer);
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                type = this.stEnd.unpack(ref srcBuf, cutVer);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
