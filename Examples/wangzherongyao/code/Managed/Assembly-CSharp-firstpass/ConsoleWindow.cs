...
public class ConsoleWindow : MonoSingleton<ConsoleWindow>
{
    ...
    {
        bool flag = !this.isVisible && this.bEnableUseGmPanel;
        this.isVisible = flag;
        return flag;
    }
    ...
    private void Update()
    {
        if (this.bEnableUseGmPanel)
        {
            if (Input.GetKeyDown(KeyCode.F1) && this.ToggleVisible())
            {
