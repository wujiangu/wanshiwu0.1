...
public class AstarDebugger : MonoBehaviour
{
    ...
    private PathTypeDebug[] debugTypes = new PathTypeDebug[] { new PathTypeDebug("ABPath", new Func<int>(null, (IntPtr) PathPool<ABPath>.GetSize), new Func<int>(null, (IntPtr) PathPool<ABPath>.GetTotalCreated)) };
    ...
    private struct PathTypeDebug
    {
        ...
        public void Print(StringBuilder text)
        {
            ...
            if (num > 0)
            {
                text.Append("\n").Append(("  " + this.name).PadRight(0x19)).Append(this.getSize.Invoke()).Append("/").Append(num);
            }
        }
    }
}
