...
public class GameMocker
{
    ...
    public const string MockRootPath = "C:/VersionBranch_v8_Unity5ToUnity4/Project/Assets";
    public const string PluginMockPath = "C:/VersionBranch_v8_Unity5ToUnity4/Project/Assets/Plugins/mock";
    public const string REFKEY = "__refKey";
    public const string RootPath = "C:/VersionBranch_v8_Unity5ToUnity4";
    public const string ScriptMockPath = "C:/VersionBranch_v8_Unity5ToUnity4/Project/Assets/Scripts/mock";
    ...
    public void CloseMock()
    {
        ...
        try
        {
            File.WriteAllText("C:/VersionBranch_v8_Unity5ToUnity4/PartialTypesOutput.txt", this._partialTypesOutput.ToString(), Encoding.UTF8);
            File.WriteAllText("C:/VersionBranch_v8_Unity5ToUnity4/MockSkipTypesOutput.txt", this._mockSkipTypesOutput.ToString(), Encoding.UTF8);
        }
        catch (Exception)
        {
        }
    ...
    public void StartMock(Type[] rootTypes)
    {
        ...
        this._gsEntryBuilder = new CodeContext("_global_", "C:/VersionBranch_v8_Unity5ToUnity4/Project/Assets/Scripts/mock");
        ...
        this._partialTypesOutput.AppendLine("C:/VersionBranch_v8_Unity5ToUnity4/Project/Assets");
    ...
    private string ValidStoreField(FieldInfo memFld)
    {
        ...
        if (((!memFld.IsLiteral && !memFld.get_IsInitOnly()) && (!string.IsNullOrEmpty(str) && (str != "__refKey"))) && !memFld.IsDefined(typeof(ObsoleteAttribute), false))
        {
            return str;
        }
        return null;
