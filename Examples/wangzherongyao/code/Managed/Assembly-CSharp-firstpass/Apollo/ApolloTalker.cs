namespace Apollo
{
    ...
    internal class ApolloTalker : ApolloObject, IApolloTalker
    {
        ...
        {
            <Register>c__AnonStorey15<TResp> storey = new <Register>c__AnonStorey15<TResp> {
                handler = handler
            };
        ...
        {
            <Register>c__AnonStorey16<TResp, TReceipt> storey = new <Register>c__AnonStorey16<TResp, TReceipt> {
                handler = handler
            };
            if ((command == null) || (storey.handler == null))
            {
        ...
        {
            <Send>c__AnonStorey14<TResp> storey = new <Send>c__AnonStorey14<TResp> {
                handler = handler
            };
        ...
        [CompilerGenerated]
        private sealed class <Register>c__AnonStorey15<TResp> where TResp: IUnpackable
        {
        ...
        [CompilerGenerated]
        private sealed class <Register>c__AnonStorey16<TResp, TReceipt> where TResp: IUnpackable where TReceipt: IPackable
        {
        ...
        [CompilerGenerated]
        private sealed class <Send>c__AnonStorey14<TResp> where TResp: IUnpackable
        {
