namespace ResData
{
    ...
    {
        public ResEffectCombine[] astEffectCombine = new ResEffectCombine[3];
        ...
        public static readonly uint LENGTH_szPassiveSkillDes = 0x80;
        ...
        public string szPassiveSkillDes;
        public byte[] szPassiveSkillDes_ByteArray = new byte[1];
        ...
        public ResEquipInBattle()
        {
            for (int i = 0; i < 3; i++)
            {
                this.astEffectCombine[i] = new ResEffectCombine();
            }
            ...
            this.szPassiveSkillDes = string.Empty;
        ...
        public TdrError.ErrorType load(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                int num8 = 0x80;
                if (this.szPassiveSkillDes_ByteArray.GetLength(0) < num8)
                {
                    this.szPassiveSkillDes_ByteArray = new byte[LENGTH_szPassiveSkillDes];
                }
                type = srcBuf.readCString(ref this.szPassiveSkillDes_ByteArray, num8);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
                ...
                for (int j = 0; j < 3; j++)
                {
                    type = this.astEffectCombine[j].load(ref srcBuf, cutVer);
                    if (type != TdrError.ErrorType.TDR_NO_ERROR)
                    {
                        return type;
                    }
                ...
                for (int k = 0; k < 3; k++)
                {
                    type = srcBuf.readUInt32(ref this.PassiveRmvSkillFuncId[k]);
                    if (type != TdrError.ErrorType.TDR_NO_ERROR)
                    {
                        return type;
                    }
        ...
        private void TransferData()
        {
            ...
            this.szPassiveSkillDes = StringHelper.UTF8BytesToString(ref this.szPassiveSkillDes_ByteArray);
            this.szPassiveSkillDes_ByteArray = null;
        ...
        public TdrError.ErrorType unpack(ref TdrReadBuf srcBuf, uint cutVer)
        {
            ...
            if (type == TdrError.ErrorType.TDR_NO_ERROR)
            {
                ...
                if (num12 > this.szPassiveSkillDes_ByteArray.GetLength(0))
                {
                    if (num12 > LENGTH_szPassiveSkillDes)
                    {
                        return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
                    }
                    this.szPassiveSkillDes_ByteArray = new byte[num12];
                }
                if (1 > num12)
                {
                    return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_SMALL;
                }
                type = srcBuf.readCString(ref this.szPassiveSkillDes_ByteArray, (int) num12);
                if (type != TdrError.ErrorType.TDR_NO_ERROR)
                {
                    return type;
                }
                if (this.szPassiveSkillDes_ByteArray[((int) num12) - 1] != 0)
                {
                    return TdrError.ErrorType.TDR_ERR_STR_LEN_CONFLICT;
                }
                int num13 = TdrTypeUtil.cstrlen(this.szPassiveSkillDes_ByteArray) + 1;
                if (num12 != num13)
                {
                    return TdrError.ErrorType.TDR_ERR_STR_LEN_CONFLICT;
                }
                ...
                for (int j = 0; j < 3; j++)
                {
                    type = this.astEffectCombine[j].unpack(ref srcBuf, cutVer);
                    if (type != TdrError.ErrorType.TDR_NO_ERROR)
                    {
                        return type;
                    }
                ...
                if (num15 > this.szDesc_ByteArray.GetLength(0))
                {
                    if (num15 > LENGTH_szDesc)
                    {
                        return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_BIG;
                    }
                    this.szDesc_ByteArray = new byte[num15];
                }
                if (1 > num15)
                {
                    return TdrError.ErrorType.TDR_ERR_STR_LEN_TOO_SMALL;
                }
                type = srcBuf.readCString(ref this.szDesc_ByteArray, (int) num15);
                if (type == TdrError.ErrorType.TDR_NO_ERROR)
                {
                    if (this.szDesc_ByteArray[((int) num15) - 1] != 0)
                    {
                        return TdrError.ErrorType.TDR_ERR_STR_LEN_CONFLICT;
                    }
                    int num16 = TdrTypeUtil.cstrlen(this.szDesc_ByteArray) + 1;
                    if (num15 != num16)
                    {
                        return TdrError.ErrorType.TDR_ERR_STR_LEN_CONFLICT;
                    }
