namespace TMPro
{
    ...
    public static class ShaderUtilities
    {
        ...
        public static float GetPadding(Material material, bool enableExtraPadding, bool isBold)
        {
            ...
            a = (num4 + num3) + num2;
            if (material.HasProperty(ID_GlowOffset) && shaderKeywords.Contains<string>(Keyword_Glow))
            {
            ...
            if (material.HasProperty(ID_UnderlaySoftness) && shaderKeywords.Contains<string>(Keyword_Underlay))
            {
        ...
        public static float GetPadding(Material[] materials, bool enableExtraPadding, bool isBold)
        {
            ...
            for (int i = 0; i < materials.Length; i++)
            {
                ...
                a = (num4 + num3) + num2;
                if (materials[i].HasProperty(ID_GlowOffset) && shaderKeywords.Contains<string>(Keyword_Glow))
                {
                ...
                a = Mathf.Max(a, (num2 + num8) + num9);
                if (materials[i].HasProperty(ID_UnderlaySoftness) && shaderKeywords.Contains<string>(Keyword_Underlay))
                {
        ...
        public static bool IsMaskingEnabled(Material material)
        {
            ...
            if (!material.shaderKeywords.Contains<string>(Keyword_MASK_SOFT) && !material.shaderKeywords.Contains<string>(Keyword_MASK_HARD))
            {
                return false;
            }
            return true;
        ...
        public static void UpdateShaderRatios(Material mat, bool isBold)
        {
            ...
            float num2 = 1f;
            float num3 = 1f;
            bool flag = !mat.shaderKeywords.Contains<string>(Keyword_Ratios);
