namespace TMPro
{
    ...
    {
        [CompilerGenerated]
        private static Func<GlyphInfo, int> <>f__am$cache12;
        [SerializeField]
        ...
        public void AddGlyphInfo(GlyphInfo[] glyphInfo)
        {
            ...
            {
                <>f__am$cache12 = new Func<GlyphInfo, int>(null, (IntPtr) <AddGlyphInfo>m__4C);
            }
            this.m_glyphInfoList = Enumerable.OrderBy<GlyphInfo, int>(this.m_glyphInfoList, <>f__am$cache12).ToList<GlyphInfo>();
        }
