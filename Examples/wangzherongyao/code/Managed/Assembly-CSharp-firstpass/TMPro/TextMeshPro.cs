namespace TMPro
{
    ...
    [RequireComponent(typeof(MeshFilter)), RequireComponent(typeof(TextContainer)), AddComponentMenu("Mesh/TextMesh Pro"), RequireComponent(typeof(MeshRenderer)), ExecuteInEditMode]
        ...
        private void GenerateTextMesh()
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    this.loopCountA++;
                    int endIndex = 0;
                    SProfiler.BeginSample("First Pass");
                    ...
                    else
                    {
                        ...
                        if (this.m_renderMode != TextRenderFlags.GetPreferredSizes)
                        {
                            ...
                            else
                            {
                                ...
                                int num39 = 0;
                                int num40 = 0;
                                SProfiler.BeginSample("Second Pass");
