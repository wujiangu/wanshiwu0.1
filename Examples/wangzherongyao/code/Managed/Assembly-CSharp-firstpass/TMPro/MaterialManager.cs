namespace TMPro
{
    ...
    public static class MaterialManager
    {
        ...
        {
            <AddMaskingMaterial>c__AnonStorey42 storey = new <AddMaskingMaterial>c__AnonStorey42 {
                stencilMaterial = stencilMaterial
            };
            int num = m_materialList.FindIndex(new Predicate<MaskingMaterial>(storey.<>m__44));
            if (num == -1)
            {
        ...
        {
            if (m_materialList.Count<MaskingMaterial>() == 0)
            {
                Debug.Log("Material List has already been cleared.");
            }
            else
            {
                for (int i = 0; i < m_materialList.Count<MaskingMaterial>(); i++)
                {
        ...
        {
            <GetBaseMaterial>c__AnonStorey41 storey = new <GetBaseMaterial>c__AnonStorey41 {
                stencilMaterial = stencilMaterial
            };
            int num = m_materialList.FindIndex(new Predicate<MaskingMaterial>(storey.<>m__43));
            if (num == -1)
            {
                return null;
            }
        ...
        {
            <GetStencilMaterial>c__AnonStorey40 storey = new <GetStencilMaterial>c__AnonStorey40 {
                baseMaterial = baseMaterial,
                stencilID = stencilID
            };
            ...
            int num = m_materialList.FindIndex(new Predicate<MaskingMaterial>(storey.<>m__42));
            if (num == -1)
            {
        ...
        {
            <ReleaseBaseMaterial>c__AnonStorey44 storey = new <ReleaseBaseMaterial>c__AnonStorey44 {
                baseMaterial = baseMaterial
            };
            int index = m_materialList.FindIndex(new Predicate<MaskingMaterial>(storey.<>m__46));
            if (index == -1)
            {
        ...
        {
            <ReleaseStencilMaterial>c__AnonStorey45 storey = new <ReleaseStencilMaterial>c__AnonStorey45 {
                stencilMaterial = stencilMaterial
            };
            int index = m_materialList.FindIndex(new Predicate<MaskingMaterial>(storey.<>m__47));
            if (index != -1)
            {
        ...
        {
            <RemoveStencilMaterial>c__AnonStorey43 storey = new <RemoveStencilMaterial>c__AnonStorey43 {
                stencilMaterial = stencilMaterial
            };
            int index = m_materialList.FindIndex(new Predicate<MaskingMaterial>(storey.<>m__45));
            if (index != -1)
            {
                m_materialList.RemoveAt(index);
            }
        ...
        [CompilerGenerated]
        private sealed class <AddMaskingMaterial>c__AnonStorey42
        {
            internal Material stencilMaterial;

            internal bool <>m__44(MaterialManager.MaskingMaterial item)
            {
        ...
        [CompilerGenerated]
        private sealed class <GetBaseMaterial>c__AnonStorey41
        {
            internal Material stencilMaterial;

            internal bool <>m__43(MaterialManager.MaskingMaterial item)
            {
                return (item.stencilMaterial == this.stencilMaterial);
            }
        }
        ...
        [CompilerGenerated]
        private sealed class <GetStencilMaterial>c__AnonStorey40
        {
            internal Material baseMaterial;
            internal int stencilID;

            internal bool <>m__42(MaterialManager.MaskingMaterial item)
            {
        ...
        [CompilerGenerated]
        private sealed class <ReleaseBaseMaterial>c__AnonStorey44
        {
            internal Material baseMaterial;

            internal bool <>m__46(MaterialManager.MaskingMaterial item)
            {
        ...
        [CompilerGenerated]
        private sealed class <ReleaseStencilMaterial>c__AnonStorey45
        {
            internal Material stencilMaterial;

            internal bool <>m__47(MaterialManager.MaskingMaterial item)
            {
                return (item.stencilMaterial == this.stencilMaterial);
            }
        }
        ...
        [CompilerGenerated]
        private sealed class <RemoveStencilMaterial>c__AnonStorey43
        {
            internal Material stencilMaterial;

            internal bool <>m__45(MaterialManager.MaskingMaterial item)
            {
                return (item.stencilMaterial == this.stencilMaterial);
            }
        }
