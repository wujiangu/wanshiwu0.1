namespace TMPro
{
    ...
    [RequireComponent(typeof(CanvasRenderer)), ExecuteInEditMode, RequireComponent(typeof(RectTransform)), AddComponentMenu("UI/TextMeshPro Text", 12), DisallowMultipleComponent]
