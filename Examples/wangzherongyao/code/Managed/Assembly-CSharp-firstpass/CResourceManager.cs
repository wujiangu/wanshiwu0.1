...
public class CResourceManager : Singleton<CResourceManager>
{
    ...
    {
        return new <LoadResidentAssetBundles>c__IteratorF { <>f__this = this };
    }
    ...
    [CompilerGenerated]
    private sealed class <LoadResidentAssetBundles>c__IteratorF : IDisposable, IEnumerator, IEnumerator<object>
    {
