namespace PigeonCoopToolkit.Utillities
{
    ...
    public class CircularBuffer<T> : IEnumerable, IList<T>, ICollection<T>, IEnumerable<T>
    {
        ...
        {
            return new <GetEnumerator>c__IteratorE<T> { <>f__this = (CircularBuffer<T>) this };
        }
        ...
        [CompilerGenerated]
        private sealed class <GetEnumerator>c__IteratorE : IDisposable, IEnumerator, IEnumerator<T>
        {
            internal T $current;
            internal int $PC;
