namespace AGE
{
    ...
    public class PlayHeroSoundTick : TickEvent
    {
        ...
        public override void Process(Action _action, Track _track)
        {
            ...
            {
                Singleton<CSoundManager>.instance.PlayBattleSound(this.eventName, gameObject);
            }
            else
            {
                ...
                Singleton<CSoundManager>.instance.PlayBattleSound(this.CachedEventName, gameObject);
            }
        }
