    ...
    public class OnTrigger : DurationCondition
    {
        ...
        public override bool Check(Action _action, Track _track)
        {
            ...
            if (gameObject != null)
            {
                ...
                List<GameObject> list = type.InvokeMember(this.methodName, BindingFlags.InvokeMethod | BindingFlags.NonPublic | BindingFlags.Public | BindingFlags.Static | BindingFlags.Instance | BindingFlags.DeclaredOnly, null, component, objArray) as List<GameObject>;
