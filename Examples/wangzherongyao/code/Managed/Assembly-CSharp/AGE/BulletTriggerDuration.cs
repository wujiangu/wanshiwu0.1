namespace AGE
{
    ...
    public class BulletTriggerDuration : DurationCondition
    {
        ...
        private bool ShouldStop()
        {
            ...
            if (this.DependCheckType == EDependCheckType.Move)
            {
                return this.MoveBulletContext.stopCondtion;
            }
            if (this.DependCheckType == EDependCheckType.HitOrMove)
            {
                return (this.HitTriggerContext.hit || this.MoveBulletContext.stopCondtion);
            }
            return ((this.DependCheckType == EDependCheckType.HitAndMove) && (this.HitTriggerContext.hit && this.MoveBulletContext.stopCondtion));
        }
    }
}
