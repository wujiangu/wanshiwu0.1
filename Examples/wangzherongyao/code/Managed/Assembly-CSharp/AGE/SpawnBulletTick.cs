                ...
                else
                {
                    ...
                    if (refParamObject != null)
                    {
                        if (!refParamObject.bSpecialUse)
                        {
                            ...
                            {
                                skillControl.SpawnBullet(refParamObject, this.ActionName, this.bDeadRemove);
                            }
                        }
                        else if (this.SpecialActionName != string.Empty)
                        {
                            skillControl.SpawnBullet(refParamObject, this.SpecialActionName, this.bDeadRemove);
                        }
                        _action.refParams.SetRefParam("_BulletPos", refParamObject.UseVector);
                    }
                }
            }
        }
