...
public class CMailView
{
    ...
    public void UpdateListElenment(GameObject element, CMail mail)
    {
        ...
        text2.text = Utility.GetTimeBeforString((long) mail.sendTime, (long) num);
        ...
        else if (mail.mailType == COM_MAIL_TYPE.COM_MAIL_FRIEND)
        {
            ...
            if (!CSysDynamicBlock.bFriendBlocked)
            {
                ...
                if (comdt_friend_info != null)
                {
                    string str = Utility.UTF8Convert(comdt_friend_info.szHeadUrl);
                    if (!string.IsNullOrEmpty(str))
                    {
                        script.SetImageUrl(Singleton<ApolloHelper>.GetInstance().ToSnsHeadUrl(str));
                    }
                }
            }
        }
    ...
    public CUIFormScript Form
    {
        set
        {
            ...
            {
                this.m_CUIListScriptTab.SetElementAmount(0);
            ...
            else
            {
                ...
                this.m_deleteBtn = this.m_panelSys.transform.FindChild("ButtonGrid/DeleteButton").gameObject;
                ...
                this.CurMailType = COM_MAIL_TYPE.COM_MAIL_SYSTEM;
            }
        }
    }
}
