...
public class CMallItem
{
    ...
    public bool CanSendFriend()
    {
        ...
        else
        {
            ...
            return CHeroSkinBuyManager.ShouldShowBuyForFriend(false, this.m_heroData.cfgID, 0);
        }
        if (this.m_skinData == null)
        {
            return false;
        }
        return CHeroSkinBuyManager.ShouldShowBuyForFriend(true, this.m_skinData.dwHeroID, this.m_skinData.dwSkinID);
    }
    ...
    public enHeroJobType Job()
    {
        ...
        {
            return (enHeroJobType) this.m_heroData.heroCfgInfo.bJob;
        }
    ...
    public string ObtWay()
    {
        ...
        else
        {
            ...
            return this.m_heroData.heroCfgInfo.szObtWay;
        }
        if (this.m_skinData == null)
        {
            return null;
        }
        return this.m_skinData.szGetPath;
    }
    ...
    public byte ObtWayType()
    {
        ...
        else
        {
            ...
            return this.m_heroData.heroCfgInfo.bObtWayType;
        }
        if (this.m_skinData == null)
        {
            return 0;
        }
        return this.m_skinData.bGetPathType;
    }
