...
public class NewbieGuideCheckTriggerConditionUtil
{
    ...
    public static bool CheckTriggerCondition(uint id, NewbieGuideTriggerConditionItem condition)
    {
        ...
        switch (condition.wType)
        {
            ...
            case 0x2d:
                return Singleton<CHeroSelectSystem>.instance.IsSelSkillAvailable();
            ...
            case 0x31:
            {
                ...
                {
                    if ((tasks[i].m_baseId == condition.Param[0]) && (tasks[i].m_taskState == 1))
                    {
                        return true;
                    }
                }
            ...
            case 0x35:
            {
                ...
                return curLvelContext.IsPvpGameType();
            }
            case 0x36:
            {
                bool flag12 = false;
