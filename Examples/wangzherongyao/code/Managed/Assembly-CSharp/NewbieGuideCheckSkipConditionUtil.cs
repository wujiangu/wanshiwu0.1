...
public class NewbieGuideCheckSkipConditionUtil
{
    public static bool CheckSkipCondition(NewbieGuideSkipConditionItem item, uint[] param)
    {
        switch (item.wType)
        {
            ...
            case 30:
                return Singleton<CRoleInfoManager>.GetInstance().GetMasterRoleInfo().IsNewbieAchieveSet((int) item.Param[0]);
            ...
            case 0x31:
            {
                ...
                if (info4 != null)
                {
                    bool flag2 = info4.IsGuidedStateSet(0x59);
                    bool flag3 = info4.IsGuidedStateSet(90);
                    bool flag4 = flag2 || flag3;
                    return (info4.IsGuidedStateSet(0x59) || info4.IsGuidedStateSet(90));
                }
                return false;
            }
            default:
