...
{
    [CompilerGenerated]
    private static IDIPSys.LoadRCallBack <>f__am$cache12;
    [CompilerGenerated]
    ...
    public void PreLoadImage()
    {
        ...
        for (int i = 0; i < noticeUrl.Count; i++)
        {
            ...
            {
                <>f__am$cache12 = text2 => BugLocateLogSys.Log("preloadimage ok");
            }
            base.StartCoroutine(MonoSingleton<IDIPSys>.GetInstance().DownloadImage(noticeUrl[i], <>f__am$cache12));
        }
        ...
        for (int j = 0; j < list2.Count; j++)
        {
            ...
            base.StartCoroutine(MonoSingleton<IDIPSys>.GetInstance().DownloadImage(list2[j], <>f__am$cache13));
        }
    }
