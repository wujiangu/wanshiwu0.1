...
public class CMallBoutiqueController : Singleton<CMallBoutiqueController>
{
    ...
    public void Draw(CUIFormScript form)
    {
        ...
        if (!this.RefreshData())
        {
            Singleton<CUIManager>.GetInstance().OpenTips("Initializing data failed", false, 1f, null, new object[0]);
        ...
        else
        {
            ...
            Singleton<EventRouter>.GetInstance().AddEventHandler(EventID.Mall_Change_Tab, new Action(this, (IntPtr) this.OnMallTabChange));
    ...
    {
        Singleton<CMallSystem>.GetInstance().LoadUIPrefab("UGUI/Form/System/Mall/Boutique", "pnlBoutique", form.GetWidget(3), form);
    }
        ...
        else
        {
            ...
            if (shopProduct.CanBuy())
            {
                ...
                else
                {
                    ...
                    BuyPickDialog.Show(shopProduct.Type, shopProduct.ID, shopProduct.CoinType, shopProduct.Discount, maxCount, new BuyPickDialog.OnConfirmBuyDelegate(Singleton<CMallFactoryShopController>.GetInstance().BuyShopProduct), shopProduct, null, uieventPars);
                }
            }
        }
    }
    ...
    private void OnMallTabChange()
    {
        if ((Singleton<CMallSystem>.GetInstance().m_MallForm != null) && Singleton<CMallSystem>.GetInstance().m_IsMallFormOpen)
        {
            ...
            Singleton<EventRouter>.GetInstance().RemoveEventHandler(EventID.Mall_Change_Tab, new Action(this, (IntPtr) this.OnMallTabChange));
            ...
            Singleton<EventRouter>.GetInstance().RemoveEventHandler<uint, uint, uint>("HeroSkinAdd", new Action<uint, uint, uint>(this, (IntPtr) this.OnNtyAddSkin));
        }
    }
