...
public class AkMemBankLoader : MonoBehaviour
{
    ...
    {
        return new <LoadFile>c__Iterator24 { <>f__this = this };
    }
    ...
    [CompilerGenerated]
    private sealed class <LoadFile>c__Iterator24 : IDisposable, IEnumerator, IEnumerator<object>
    {
        ...
        public bool MoveNext()
        {
            ...
            switch (num)
            {
                ...
                case 1:
                    ...
                    {
                        Debug.LogError("AkMemBankLoader: bank loading failed with result " + this.<result>__6.ToString());
                    }
                    this.$PC = -1;
                    break;
            }
