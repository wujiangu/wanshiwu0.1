...
public class Sprite3D : MonoBehaviour
{
    ...
    public void SetNativeSize(Camera camera, float depth)
    {
        ...
        if (camera != null)
        {
            ...
            Vector3 vector3 = new Vector3(vector2.x + this.m_uv.width, vector2.y, vector2.z);
            Vector3 vector4 = new Vector3(vector2.x, vector2.y + this.m_uv.height, vector2.z);
