namespace Assets.Scripts.UI
{
    ...
    public class CUIFormScript : MonoBehaviour, IComparable
    {
        ...
        private bool m_isHidedByOtherForm;
        ...
        private void DispatchHideFormEvent()
        {
            CUIEvent uIEvent = Singleton<CUIEventManager>.GetInstance().GetUIEvent();
            uIEvent.m_eventID = enUIEventID.UI_OnFormHide;
            uIEvent.m_srcFormScript = this;
            uIEvent.m_srcWidget = null;
            uIEvent.m_srcWidgetScript = null;
            uIEvent.m_srcWidgetBelongedListScript = null;
        ...
        public void HideByOtherForm()
        {
            if (!this.m_alwaysKeepVisible)
            {
                this.Hide(false);
                this.m_isHidedByOtherForm = true;
        ...
        public bool IsHidedByOtherForm()
        {
            return this.m_isHidedByOtherForm;
        }
        ...
        public void RevertToVisibleFromHideByOtherForm()
        {
            if (this.m_isHidedByOtherForm)
            {
                this.Appear();
                this.m_isHidedByOtherForm = false;
