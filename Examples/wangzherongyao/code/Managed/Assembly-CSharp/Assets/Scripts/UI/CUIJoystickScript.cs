namespace Assets.Scripts.UI
{
    ...
    public class CUIJoystickScript : CUIComponent, IPointerDownHandler, IEventSystemHandler, IPointerClickHandler, IBeginDragHandler, IDragHandler, IEndDragHandler
    {
        private const float c_axisFadeoutAlpha = 0.5490196f;
        ...
        private void AxisFadeout()
        {
            if (this.m_axisImage != null)
            {
                this.m_axisImage.color = new Color(1f, 1f, 1f, 0.5490196f);
            }
            if (this.m_cursorImage != null)
            {
                this.m_cursorImage.color = new Color(1f, 1f, 1f, 0.5490196f);
            }
        }
        ...
        {
            if ((axis == Vector2.zero) && (this.m_axis != axis))
            {
                this.m_axis = axis;
                this.DispatchOnAxisChangedEvent();
            }
