namespace Assets.Scripts.GameLogic
{
    ...
    public class BurnExpeditionUT
    {
        ...
        {
            ResSkillCombineCfgInfo dataByKey = GameDataMgr.skillCombineDatabin.GetDataByKey(buffid);
            if (dataByKey == null)
            {
                return -1;
            }
        ...
        {
            return GameDataMgr.burnMap.GetDataByKey(Singleton<BurnExpeditionController>.GetInstance().model.Get_LevelID(levelIndex));
        }
