namespace Assets.Scripts.GameLogic
{
    ...
    public class TriggerActionNewbieForm : TriggerActionBase
    {
        ...
        {
            if ((base.EnterUniqueId > 0) && (base.EnterUniqueId < 0x1d))
            {
                Singleton<CBattleGuideManager>.GetInstance().OpenFormShared((CBattleGuideManager.EBattleGuideFormType) base.EnterUniqueId, 0);
            }
            return null;
        }
    }
