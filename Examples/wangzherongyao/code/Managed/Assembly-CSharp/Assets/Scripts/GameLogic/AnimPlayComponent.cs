    ...
    public class AnimPlayComponent : LogicComponent
    {
        ...
        public void RecoverAnimParam(string _changeAnimName)
        {
            ...
            for (int i = 0; i < this.changeList.Count; i++)
            {
                ...
                if (param.originalAnimName == _changeAnimName)
                {
                    index = i;
                    break;
                }
            ...
            if (index >= 0)
            {
                this.ChangeCurAnimParam(this.changeList[index], true);
        ...
        public void Stop(string animName, bool bFlag = false)
        {
            if (((base.actor.ActorMesh != null) && (base.actor.ActorMeshAnimation != null)) && (base.actor.ActorMeshAnimation.GetClip(animName) != null))
            {
                bool flag = false;
                ...
                if (flag && bFlag)
                {
                    ...
                    {
                        base.actor.ActorMeshAnimation[animName].enabled = false;
                    }
                }
            }
        }
