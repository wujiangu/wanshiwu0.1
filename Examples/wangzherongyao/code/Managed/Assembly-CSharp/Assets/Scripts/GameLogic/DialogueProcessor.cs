namespace Assets.Scripts.GameLogic
{
    ...
    public class DialogueProcessor : MonoSingleton<DialogueProcessor>
    {
        ...
        private AGE.Action m_curAction;
        ...
        private void DoNextPageInternal()
        {
            ...
            if ((this.m_curUiForm != script) && (script != null))
            {
                ...
                {
                    this.m_curUiForm.Hide(true);
                    if (this.m_curUiFormPortrait != null)
                    {
                        this.m_curUiFormPortrait.Hide(true);
                    }
                }
                this.m_curUiForm = script;
                if (this.m_curUiForm != null)
                {
                    this.m_curUiForm.Appear();
                    if ((node.DialogStyle == 0) && (this.m_curUiFormPortrait != null))
                    {
                        this.m_curUiFormPortrait.Appear();
                    }
                }
            }
            if (this.m_curUiForm != null)
        ...
        {
            return new <NextPageNoTimeScale>c__Iterator7 { <>f__this = this };
        }

        private void OnActionStoped(AGE.Action action)
        {
            if (action != null)
            {
                action.onActionStop -= new ActionStopDelegate(this.OnActionStoped);
        ...
        {
            if ((this.m_curAction != null) && !ActionManager.Instance.IsActionValid(this.m_curAction))
            {
                return false;
            }
            this.m_curAction = PlayAgeAction(this.m_ageActName, this.m_ageActName, inSrc, inAtker, new ActionStopDelegate(this.OnActionStoped), -1);
            if (this.m_curAction != null)
            {
                this.m_curAction.refParams.AddRefParam("DialogGroupIdRaw", inGroupId);
            }
            return (this.m_curAction != null);
        }

        [DebuggerHidden]
        public static IEnumerator PlayAnimNoTimeScale(Animation animation, string clipName, bool bLoop, System.Action onComplete)
        {
            return new <PlayAnimNoTimeScale>c__Iterator8 { animation = animation, clipName = clipName, bLoop = bLoop, onComplete = onComplete, <$>animation = animation, <$>clipName = clipName, <$>bLoop = bLoop, <$>onComplete = onComplete };
        }
        ...
        {
            return new <StartFadingIn>c__IteratorA { <>f__this = this };
        }

        [DebuggerHidden]
        private IEnumerator StartFadingOut()
        {
            return new <StartFadingOut>c__Iterator9 { <>f__this = this };
        }
                        ...
                        if (((preNode.AnimName != node.AnimName) || (preNode.bAnimLoop != node.bAnimLoop)) || (((preNode.b3dPortrait != node.b3dPortrait) || (preNode.ActorType != node.ActorType)) || (preNode.CharCfgId != node.CharCfgId)))
                        {
                            ...
                            if (key != null)
                            {
                                ...
                                if (animation != null)
                                {
                                    ...
                                    Coroutine coroutine = base.StartCoroutine(PlayAnimNoTimeScale(animation, clipName, node.bAnimLoop, new System.Action(this, (IntPtr) this.OnPortrait3dAnimComplete)));
                                    this.Portrait3dAnimCoMap.Add(key, coroutine);
                                }
                            }
                        }
        ...
        [CompilerGenerated]
        private sealed class <NextPageNoTimeScale>c__Iterator7 : IDisposable, IEnumerator, IEnumerator<object>
        {
        ...
        [CompilerGenerated]
        private sealed class <PlayAnimNoTimeScale>c__Iterator8 : IDisposable, IEnumerator, IEnumerator<object>
        {
            internal object $current;
            internal int $PC;
        ...
        [CompilerGenerated]
        private sealed class <StartFadingIn>c__IteratorA : IDisposable, IEnumerator, IEnumerator<object>
        {
            internal object $current;
            internal int $PC;
        ...
        [CompilerGenerated]
        private sealed class <StartFadingOut>c__Iterator9 : IDisposable, IEnumerator, IEnumerator<object>
        {
            internal object $current;
            internal int $PC;
            internal float <_progressTime>__1;
