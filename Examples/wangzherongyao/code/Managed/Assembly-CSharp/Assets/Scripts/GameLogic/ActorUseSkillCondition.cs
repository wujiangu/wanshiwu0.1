namespace Assets.Scripts.GameLogic
{
    ...
    public class ActorUseSkillCondition : PassiveCondition
    {
        ...
        public override void Init(PoolObjHandle<ActorRoot> _source, PassiveEvent _event, ref ResDT_SkillPassiveCondition _config)
        {
            ...
            Singleton<GameSkillEventSys>.instance.AddEventHandler<ActorSkillEventParam>(GameSkillEventDef.Event_UseSkill, new GameSkillEvent<ActorSkillEventParam>(this.onActorUseSkill));
        }
        ...
        {
            Singleton<GameSkillEventSys>.instance.RmvEventHandler<ActorSkillEventParam>(GameSkillEventDef.Event_UseSkill, new GameSkillEvent<ActorSkillEventParam>(this.onActorUseSkill));
        }
    }
}
