            ...
            if (Singleton<GamePlayerCenter>.instance.GetPlayer(actorMeta.PlayerId) != null)
            {
                ...
                while (enumerator.MoveNext())
                {
                    if ((enumerator.Current != null) && (actorMeta.ActorCamp == enumerator.Current.CampType))
                    {
                        ...
                        actorDataProvider.GetActorServerData(ref actorMeta, ref actorData);
                        ...
                        if (!bGiveBirth)
                        {
                            ...
                            else if (length >= 1)
                            {
                                ...
                                {
                                    transform = enumerator.Current.SubRevivePlaces[index].transform;
                                }
                            }
                        }
                        ...
                        if (transform != null)
                        {
                            if (bornPointIndex < transform.childCount)
                            {
                                child = transform.GetChild(bornPointIndex);
                            }
                            else
                            {
                                child = transform;
