namespace Assets.Scripts.GameLogic
{
    ...
    public class ObjAgent : BTBaseAgent, IPooledMonoBehaviour, IActorComponent
    {
        ...
        private AGE.Action m_currentAction;
        ...
        public const float SKILL_ALLOWABLE_ERROR_VALUE = 1.21f;
        ...
        public EBTStatus AbortCurUseSkillByType(SkillAbortType abortType)
        {
            ...
            if (curUseSkillSlot.Abort(abortType))
            {
                return EBTStatus.BT_SUCCESS;
            }
        ...
        public uint AdvanceCommonAttackSearchEnemy(int srchR)
        {
            ...
            {
                return currentAttackMode.CommonAttackSearchEnemy(srchR);
            }
            return 0;
        }
        ...
        public virtual void Born(ActorRoot actor)
        {
            ...
            if ((((curLvelContext == null) || !curLvelContext.isPVPLevel) || ((curLvelContext.DynamicDifficultyCfg == null) || (ownerPlayer == null))) || !ownerPlayer.Computer)
            {
            ...
            {
                int iAILevel = curLvelContext.DynamicDifficultyCfg.iAILevel;
        ...
        {
            uint dwSkillTargetFilter = this.m_wrapper.GetNextSkill(InSlot).cfgData.dwSkillTargetFilter;
        ...
        public bool CheckUseSkillPosition()
        {
            ...
            {
                SkillUseContext curSkillUseInfo = this.m_wrapper.curSkillUseInfo;
                if (curSkillUseInfo == null)
                {
                    return false;
                }
        ...
        {
            if (this.m_wrapper.curSkillUseInfo == null)
            {
        ...
        {
            uint filter = 0;
            Skill nextSkill = this.m_wrapper.GetNextSkill(InSlot);
            if ((nextSkill != null) && (nextSkill.cfgData != null))
            {
                filter = nextSkill.cfgData.dwSkillTargetFilter;
            }
        ...
        {
            return Singleton<BattleLogic>.GetInstance().GetCurLvelContext().AIModeType;
        }
        ...
        {
            ActorRoot root = Singleton<TargetSearcher>.GetInstance().GetNearestEnemy(this.m_wrapper.actor, srchR, 0);
            if (root != null)
            {
                return root.ObjID;
            }
        ...
        {
            ActorRoot root = Singleton<TargetSearcher>.GetInstance().GetNearestEnemy(this.m_wrapper.actor, srchR, priotity, 0);
            if (root != null)
            {
                return root.ObjID;
            }
        ...
        public SkillTargetRule GetSkillTargetRule(SkillSlotType InSlot)
        {
            ...
            if ((nextSkill != null) && (nextSkill.cfgData != null))
            {
                return (SkillTargetRule) nextSkill.cfgData.dwSkillTargetRule;
            }
        ...
        public RES_SUMMONERSKILL_TYPE GetSummonerSkillType(SkillSlotType InSlot)
        {
            ...
            if ((nextSkill != null) && (nextSkill.cfgData != null))
            {
                return (RES_SUMMONERSKILL_TYPE) nextSkill.cfgData.bSkillType;
            }
        ...
        public bool IsContinueAbortUseSkill()
        {
            ...
            {
                SkillSlot curUseSkillSlot = this.m_wrapper.actor.SkillControl.CurUseSkillSlot;
                if ((curUseSkillSlot != null) && curUseSkillSlot.IsAbort(SkillAbortType.TYPE_SKILL_0))
                {
                    return true;
                }
            }
            else if ((((playerOperateMode == OperateMode.LockMode) && (curUseSkill != null)) && (curUseSkill.cfgData != null)) && (((curUseSkill.AppointType == SkillRangeAppointType.Target) && (curUseSkill.cfgData.dwSkillTargetRule != 2)) || (curUseSkill.AppointType == SkillRangeAppointType.Pos)))
            {
                ...
                if (lockTargetAttackModeControl != null)
                {
                    ...
                    if (lockTargetAttackModeControl.IsValidLockTargetID(lockTargetID))
                    {
                        SkillSlot slot2 = this.m_wrapper.actor.SkillControl.CurUseSkillSlot;
                        if ((slot2 != null) && slot2.IsAbort(SkillAbortType.TYPE_SKILL_0))
                        {
                            return true;
                        }
                    }
                ...
                if (nextSkill != null)
                {
                    ...
                    switch (curSkillUseInfo.AppointType)
                    {
                        case SkillRangeAppointType.Target:
                        {
                            ...
                            num *= num;
                            VInt3 num4 = this.m_wrapper.actorLocation - curSkillUseInfo.TargetActor.handle.location;
                            return (num4.sqrMagnitudeLong2D > num);
                        }
                        case SkillRangeAppointType.Pos:
                        {
                            num = (long) (nextSkill.cfgData.iMaxAttackDistance * nextSkill.cfgData.iMaxAttackDistance);
                            num = (long) (num * 1.21f);
                            VInt3 num3 = this.m_wrapper.actorLocation - curSkillUseInfo.UseVector;
                            long num2 = num3.sqrMagnitudeLong2D - num;
                            if (num2 <= 0L)
                            {
                                return false;
                            }
        ...
        {
            if (this.m_wrapper.IsUseAdvanceCommonAttack() && (this.m_wrapper.actor.SkillControl.SkillUseCache != null))
            {
        ...
        public EBTStatus PlayAgeAction(string actionName)
        {
            ...
            {
                if (ActionManager.Instance.IsActionValid(this.m_currentAction))
                {
                    return EBTStatus.BT_RUNNING;
                }
                this.m_isActionPlaying = false;
            ...
            this.m_currentAction = ActionManager.Instance.PlayAction(actionName, true, true, objArray1);
        ...
        public EBTStatus PlayDeadAgeAction()
        {
            ...
            GameObject[] objArray1 = new GameObject[] { base.gameObject };
            this.m_currentAction = ActionManager.Instance.PlayAction(deadAgePath, true, false, objArray1);
            if (this.m_currentAction == null)
            {
                return EBTStatus.BT_FAILURE;
            }
        ...
        public EBTStatus PlayHelperAgeAction(string actionName)
        {
            ...
            this.m_currentAction = component.PlayAction(actionName);
            if (this.m_currentAction == null)
            {
                return EBTStatus.BT_FAILURE;
            }
        ...
        public void ShowAtkSignal()
        {
            ...
            if (signalPanel != null)
            {
                ...
                signalPanel.ExecCommand(playerId, configId, 2, 0, 0, 0, 0, 0, 0, 0);
            }
        }
        ...
        public void ShowRandomSignal()
        {
            ...
            if (signalPanel != null)
            {
                ...
                signalPanel.ExecCommand(playerId, configId, signalID, num6 / 0x3e8, y / 0x3e8, num8 / 0x3e8, 0, 0, 0, 0);
            }
        }
        ...
        public void ShowTogetherSignal()
        {
            ...
            if (signalPanel != null)
            {
                ...
                uint playerId = ownerPlayer.PlayerId;
                uint configId = (uint) ownerPlayer.Captain.handle.TheActorMeta.ConfigId;
                signalPanel.ExecCommand(playerId, configId, 4, 0, 0, 0, 0, 0, 0, 0);
            }
        }
            ...
            if (!base.m_isPaused)
            {
                ...
                if (this.m_wrapper != null)
                {
                    if (this.m_wrapper.actor.TheActorMeta.ActorType == ActorTypeDef.Actor_Type_Hero)
                    {
                        ...
                        {
                            if (((this.m_frame + ((int) this.m_wrapper.actor.ObjID)) % 4) == 0)
                            {
                    ...
                    else
                    {
                        ...
                        {
                            if (((this.m_frame + ((int) this.m_wrapper.actor.ObjID)) % 5) == 0)
                            {
                                base.UpdateLogic(delta);
                            }
                        }
                        ...
                        else if (((this.m_frame + ((int) this.m_wrapper.actor.ObjID)) % 7) == 0)
                        {
                            base.UpdateLogic(delta);
                        }
                    }
