namespace Assets.Scripts.GameSystem
{
    ...
    public class CSymbolInfo
    {
        ...
        {
            ResHeroSymbolLvl dataByKey = GameDataMgr.heroSymbolLvlDatabin.GetDataByKey((int) ((ushort) pvpLvl));
            if (dataByKey == null)
            {
                return 0;
            }
        ...
        {
            ResSymbolPos dataByKey = GameDataMgr.symbolPosDatabin.GetDataByKey((byte) (pos + 1));
            if (dataByKey == null)
            {
                return null;
            }
        ...
        {
            CRoleInfo masterRoleInfo = Singleton<CRoleInfoManager>.GetInstance().GetMasterRoleInfo();
            ResHeroSymbolLvl dataByKey = GameDataMgr.heroSymbolLvlDatabin.GetDataByKey((int) ((ushort) masterRoleInfo.PvpLevel));
            if (dataByKey != null)
            {
