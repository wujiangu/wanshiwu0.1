namespace Assets.Scripts.GameSystem
{
    ...
    internal class CGuildListController : Singleton<CGuildListController>
    {
        ...
        {
            Singleton<CUIManager>.GetInstance().OpenTips("Guild_Send_Apply_Success_Tip", true, 1f, null, new object[0]);
            this.m_View.RefreshGuildListPanel(false);
        }
        ...
        {
            Singleton<CUIManager>.GetInstance().OpenTips("Guild_Prepare_Guild_Created_Tip", true, 1f, null, new object[0]);
