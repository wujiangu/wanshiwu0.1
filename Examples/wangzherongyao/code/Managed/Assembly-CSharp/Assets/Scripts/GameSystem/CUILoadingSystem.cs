    ...
    internal class CUILoadingSystem : Singleton<CUILoadingSystem>
    {
        ...
        public void HideLoading()
        {
            ...
            else
            {
                ...
                {
                    if (((curLvelContext.GameType == COM_GAME_TYPE.COM_SINGLE_GAME_OF_ADVENTURE) || (curLvelContext.GameType == COM_GAME_TYPE.COM_SINGLE_GAME_OF_GUIDE)) || (((curLvelContext.GameType == COM_GAME_TYPE.COM_SINGLE_GAME_OF_BURNING) || (curLvelContext.GameType == COM_GAME_TYPE.COM_SINGLE_GAME_OF_ARENA)) || (curLvelContext.GameType == COM_GAME_TYPE.COM_SINGLE_GAME_OF_ACTIVITY)))
                    {
                        this.HidePveLoading();
                    }
                    else if ((((curLvelContext.GameType == COM_GAME_TYPE.COM_SINGLE_GAME_OF_COMBAT) || (curLvelContext.GameType == COM_GAME_TYPE.COM_MULTI_GAME_OF_PVP_MATCH)) || ((curLvelContext.GameType == COM_GAME_TYPE.COM_MULTI_GAME_OF_PVP_ROOM) || (curLvelContext.GameType == COM_GAME_TYPE.COM_MULTI_GAME_OF_LADDER))) || ((curLvelContext.GameType == COM_GAME_TYPE.COM_MULTI_GAME_OF_ENTERTAINMENT) || (curLvelContext.GameType == COM_GAME_TYPE.COM_MULTI_GAME_OF_REWARDMATCH)))
                    {
                        HideMultiLoading();
                    }
                }
        ...
        private void ShowPveLoading()
        {
            ...
            if (curLvelContext != null)
            {
                ...
                {
                    if (curLvelContext.iLevelID == 1)
                    {
                        randNum = 1;
                    }
                    else if (curLvelContext.iLevelID == 3)
                    {
                        randNum = 2;
                    }
                    else if (curLvelContext.iLevelID == 8)
                    {
                        randNum = 3;
                    }
                    else
            ...
            {
                component.SetSprite(string.Format("{0}{1}{2}", "UGUI/Sprite/Dynamic/", "Loading_truecolor/LoadingNotice", randNum), _singlePlayerLoading, true, false, false);
            }
        }
