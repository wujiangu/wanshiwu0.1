namespace Assets.Scripts.GameSystem
{
    ...
    public class CGuildSystem : Singleton<CGuildSystem>
    {
        ...
        public bool CanInvite(COMDT_FRIEND_INFO info)
        {
            ...
            return (((this.IsSameLogicWorld(info.stUin.dwLogicWorldId) && this.IsInNormalGuild()) && (HasManageAuthority() && (info.bGuildState == 0))) && (info.dwPvpLvl >= dwConfValue));
        }
        ...
        private static RankpointRankInfo CreateRankpointRankInfo(CSDT_RANKING_LIST_ITEM_INFO info)
        {
            if (info.dwRankNo == 0)
            {
                return CGuildHelper.CreatePlayerGuildRankpointRankInfo();
            }
        ...
        public bool HasInvited(ulong uid)
        {
            ...
            int dwConfValue = (int) GameDataMgr.guildMiscDatabin.GetDataByKey(12).dwConfValue;
            return (Singleton<CRoleInfoManager>.GetInstance().GetMasterRoleInfo().getCurrentTimeSinceLogin() < (inviteTimeInfoByUid + dwConfValue));
        }
        ...
        public bool HasRecommended(ulong uid)
        {
            ...
            int dwConfValue = (int) GameDataMgr.guildMiscDatabin.GetDataByKey(13).dwConfValue;
            return (Singleton<CRoleInfoManager>.GetInstance().GetMasterRoleInfo().getCurrentTimeSinceLogin() < (recommendTimeInfoByUid + dwConfValue));
        }
        ...
        {
            s_showCoinProfitTipMaxLevel = GameDataMgr.guildMiscDatabin.GetDataByKey(0x23).dwConfValue;
            s_rankpointProfitMax = GameDataMgr.guildMiscDatabin.GetDataByKey(40).dwConfValue;
            int count = GameDataMgr.guildLevelDatabin.count;
            s_coinProfitPercentage = new uint[count];
            for (int i = 0; i < count; i++)
            {
                ResGuildLevel dataByKey = GameDataMgr.guildLevelDatabin.GetDataByKey((int) (i + 1));
                if (dataByKey != null)
                {
        ...
        public static bool IsError(byte bResult)
        {
            switch (((COM_GUILD_ERRORCODE) bResult))
            {
                ...
                case COM_GUILD_ERRORCODE.COM_GUILD_ERR_NAME_DUP:
                    Singleton<CUIManager>.GetInstance().OpenTips("GUILD_ERR_NAME_DUP", true, 1f, null, new object[0]);
                    return true;

                case COM_GUILD_ERRORCODE.COM_GUILD_ERR_DB:
                    Singleton<CUIManager>.GetInstance().OpenTips("GUILD_ERR_DB", true, 1f, null, new object[0]);
                    return true;

                case COM_GUILD_ERRORCODE.COM_GUILD_ERR_CREATE_QUEUE_FULL:
                    Singleton<CUIManager>.GetInstance().OpenTips("GUILD_ERR_CREATE_QUEUE_FULL", true, 1f, null, new object[0]);
                    return true;

                case COM_GUILD_ERRORCODE.COM_GUILD_ERR_NO_PREPARE_GUILD:
                    Singleton<CUIManager>.GetInstance().OpenTips("GUILD_ERR_NO_PREPARE_GUILD", true, 1f, null, new object[0]);
                    return true;

                case COM_GUILD_ERRORCODE.COM_GUILD_ERR_MEMBER_FULL:
                    Singleton<CUIManager>.GetInstance().OpenTips("GUILD_ERR_MEMBER_FULL", true, 1f, null, new object[0]);
                    return true;

                case COM_GUILD_ERRORCODE.COM_GUILD_ERR_HAS_INVITED:
                    Singleton<CUIManager>.GetInstance().OpenTips("GUILD_ERR_HAS_INVITED", true, 1f, null, new object[0]);
                    return true;

                case COM_GUILD_ERRORCODE.COM_GUILD_ERR_HAS_RECOMMEND:
                    Singleton<CUIManager>.GetInstance().OpenTips("GUILD_ERR_HAS_RECOMMEND", true, 1f, null, new object[0]);
                    return true;

                case COM_GUILD_ERRORCODE.COM_GUILD_ERR_HAS_GUILD:
                    Singleton<CUIManager>.GetInstance().OpenTips("GUILD_ERR_HAS_GUILD", true, 1f, null, new object[0]);
                    return true;

                case COM_GUILD_ERRORCODE.COM_GUILD_ERR_GUILD_NOT_EXIST:
                    Singleton<CUIManager>.GetInstance().OpenTips("GUILD_ERR_GUILD_NOT_EXIST", true, 1f, null, new object[0]);
                    return true;

                case COM_GUILD_ERRORCODE.COM_GUILD_ERR_LEVEL_LIMIT:
                    Singleton<CUIManager>.GetInstance().OpenTips("GUILD_ERR_LEVEL_LIMIT", true, 1f, null, new object[0]);
                    return true;

                case COM_GUILD_ERRORCODE.COM_GUILD_ERR_INVITED_EXPIRE:
                    Singleton<CUIManager>.GetInstance().OpenTips("GUILD_ERR_INVITED_EXPIRE", true, 1f, null, new object[0]);
                    return true;

                case COM_GUILD_ERRORCODE.COM_GUILD_ERR_UPGRADE:
                    Singleton<CUIManager>.GetInstance().OpenTips("GUILD_ERR_UPGRADE", true, 1f, null, new object[0]);
                    return true;

                case COM_GUILD_ERRORCODE.COM_GUILD_ERR_FIRE_CNT_LIMIT:
                    Singleton<CUIManager>.GetInstance().OpenTips("GUILD_ERR_FIRE_CNT_LIMIT", true, 1f, null, new object[0]);
                    return true;

                case COM_GUILD_ERRORCODE.COM_GUILD_ERR_DEAL_SELF_RECOM_FAIL:
                    Singleton<CUIManager>.GetInstance().OpenTips("Guild_Err_Deal_Self_Recommend_Fail", true, 1f, null, new object[0]);
                    return true;

                case COM_GUILD_ERRORCODE.COM_GUILD_ERR_DONATE_CNT_LIMIT:
                    Singleton<CUIManager>.GetInstance().OpenTips("Guild_Err_Donate_Count_Limit", true, 1f, null, new object[0]);
                    return true;

                case COM_GUILD_ERRORCODE.COM_GUILD_ERR_DUPLICATE_GET_DIVIDEND:
                    Singleton<CUIManager>.GetInstance().OpenTips("Guild_Err_Duplicate_Has_Got_Dividend", true, 1f, null, new object[0]);
                    return true;

                case COM_GUILD_ERRORCODE.COM_GUILD_ERR_NAME_ILLEGAL:
                    Singleton<CUIManager>.GetInstance().OpenTips("Guild_Name_Contain_Invalid_Character", true, 1f, null, new object[0]);
                    return true;

                case COM_GUILD_ERRORCODE.COM_GUILD_ERR_NOTICE_ILLEGAL:
                    Singleton<CUIManager>.GetInstance().OpenTips("Guild_Bulletin_Contain_Invalid_Character", true, 1f, null, new object[0]);
                    return true;

                case COM_GUILD_ERRORCODE.COM_GUILD_ERR_FACTORY_LEVEL_LIMIT:
                    Singleton<CUIManager>.GetInstance().OpenTips("Guild_Symbol_Err_Factory_Level_Limit", true, 1f, null, new object[0]);
                    return true;

                case COM_GUILD_ERRORCODE.COM_GUILD_ERR_CONSTRUCT_NOT_ENOUGH:
                    Singleton<CUIManager>.GetInstance().OpenTips("Guild_Symbol_Err_Construct_Not_Enough", true, 1f, null, new object[0]);
                    return true;

                case COM_GUILD_ERRORCODE.COM_GUILD_ERR_HIS_CONSTRUCT_NOT_ENOUGH:
                    Singleton<CUIManager>.GetInstance().OpenTips("Guild_Symbol_Err_History_Construct_Not_Enough", true, 1f, null, new object[0]);
                    return true;

                case COM_GUILD_ERRORCODE.COM_GUILD_ERR_UPGRADE_GUILD_FAIL:
                    Singleton<CUIManager>.GetInstance().OpenTips("GUILD_ERR_UPGRADE_GUILD_FAIL", true, 1f, null, new object[0]);
                    return true;

                case COM_GUILD_ERRORCODE.COM_GUILD_ERR_HAS_SIGNIN:
                    Singleton<CUIManager>.GetInstance().OpenTips("Guild_Signed", true, 1f, null, new object[0]);
                    return true;

                case COM_GUILD_ERRORCODE.COM_GUILD_ERR_NOT_SAME_LOGICWORLD:
                    Singleton<CUIManager>.GetInstance().OpenTips("GUILD_ERR_NOT_SAME_LOGICWORLD", true, 1f, null, new object[0]);
                    return true;
            }
            Singleton<CUIManager>.GetInstance().OpenTips("GUILD_ERR_UNKNOWN", true, 1f, null, new object[0]);
            return true;
        }
        ...
        public bool IsSameLogicWorld(uint logicWorldId)
        {
        ...
        private void On_OpenForm(CUIEvent uiEvent)
        {
            ...
            {
                Singleton<CUIManager>.GetInstance().OpenTips("Common_System_Not_Open_Tip", true, 1f, null, new object[0]);
            }
        ...
        public static void ReceiveGetGroupGuildIdNtf(CSPkg msg)
        {
            ...
            if (currentGuildInfo != null)
            {
                ...
                Debug.LogError("Got 32 bit guild id from server: " + currentGuildInfo.groupGuildId);
        ...
        public static void ReceiveGetPlayerGuildRankInfoRsp(CSPkg msg)
        {
            ...
            {
                RankpointRankInfo info = CreateRankpointRankInfo(stGetSpecialGuildRankInfoRsp.stItemDetail);
        ...
        public static void ReceiveGuildAppointPositionRsp(CSPkg msg)
        {
            ...
            {
                Singleton<CUIManager>.GetInstance().OpenTips("Guild_Appoint_Success", true, 1f, null, new object[0]);
            }
        }
        ...
        public static void ReceiveGuildDonateRsp(CSPkg msg)
        {
            ...
            if (!IsError(msg.stPkgData.stGuildDonateRsp.bResult))
            {
                ...
                Singleton<CUIManager>.GetInstance().OpenTips(donateSuccessTip, false, 1f, null, new object[0]);
        ...
        public static void ReceiveGuildFireMemberNtf(CSPkg msg)
        {
            ...
            {
                Singleton<CUIManager>.GetInstance().OpenTips("Guild_You_Have_Been_Fired", true, 1f, null, new object[0]);
        ...
        public static void ReceiveGuildFireMemberRsp(CSPkg msg)
        {
            if (!IsError(msg.stPkgData.stFireGuildMemberRsp.bResult))
            {
                ...
                Singleton<CUIManager>.GetInstance().OpenTips(Singleton<CTextManager>.GetInstance().GetText("Guild_Fire_Member_Success", args), true, 1f, null, new object[0]);
            }
        }
        ...
        public static void ReceiveGuildInviteRsp(CSPkg msg)
        {
            ...
            if (IsError(msg.stPkgData.stGuildInviteRsp.bResult))
            {
                if (msg.stPkgData.stGuildInviteRsp.bResult == 6)
                {
                    ...
                    Singleton<CUIManager>.GetInstance().OpenTips("Guild_Friend_Has_Been_Invited_Tip", true, 1f, null, new object[0]);
            ...
            else
            {
                ...
                Singleton<CUIManager>.GetInstance().OpenTips("Guild_Invite_Success_Tip", true, 1f, null, new object[0]);
                Singleton<EventRouter>.GetInstance().BroadCastEvent("Guild_Invite_Success");
            }
        }
        ...
        public static void ReceiveGuildQuitRsp(CSPkg msg)
        {
            ...
            else
            {
                ...
                Singleton<CRoleInfoManager>.GetInstance().GetMasterRoleInfo().m_extGuildInfo.dwLastQuitGuildTime = (uint) Singleton<CRoleInfoManager>.GetInstance().GetMasterRoleInfo().getCurrentTimeSinceLogin();
                Singleton<CUIManager>.GetInstance().CloseSendMsgAlert();
        ...
        public static void ReceiveGuildRecommendRsp(CSPkg msg)
        {
            ...
            if (!IsError(msg.stPkgData.stGuildRecommendRsp.bResult))
            {
                ...
                Singleton<CUIManager>.GetInstance().OpenTips("Guild_Recommend_Success_Tip", true, 1f, null, new object[0]);
        ...
        public static void ReceiveGuildSelfCommendRsp(CSPkg msg)
        {
            ...
            {
                Singleton<CUIManager>.GetInstance().OpenTips("Guild_Self_Recommend_Success", true, 1f, null, new object[0]);
            }
        }
        ...
        public static void ReceiveGuildSignInRsp(CSPkg msg)
        {
            if (!IsError((byte) msg.stPkgData.stGuildSignInRsp.iResult))
            {
                ...
                {
                    int key = (masterRoleInfo.m_gradeOfRank <= 0) ? 1 : masterRoleInfo.m_gradeOfRank;
        ...
        [MessageHandler(0x8de)]
        public static void ReceiveGuildSymbolRsp(CSPkg msg)
        {
            Singleton<CUIManager>.GetInstance().CloseSendMsgAlert();
            if (!IsError(msg.stPkgData.stGuildSymbolRsp.bResult))
            {
                if (msg.stPkgData.stGuildSymbolRsp.bOperType == 1)
                {
                    Singleton<CUIManager>.GetInstance().OpenTips("Guild_Symbol_Open_Success", true, 1f, null, new object[0]);
                }
                else if (msg.stPkgData.stGuildSymbolRsp.bOperType == 2)
                {
                    Singleton<CUIManager>.GetInstance().OpenTips("Guild_Symbol_Upgrade_Success", true, 1f, null, new object[0]);
                }
                GuildMemInfo playerGuildMemberInfo = Singleton<CGuildSystem>.GetInstance().Model.GetPlayerGuildMemberInfo();
                DebugHelper.Assert(playerGuildMemberInfo != null, "CGuildSystem.ReceiveGuildSymbolRsp(): playerGuildMemberInfo is null!!!");
                if (playerGuildMemberInfo != null)
                {
                    playerGuildMemberInfo.dwConstruct = msg.stPkgData.stGuildSymbolRsp.dwCurConstruct;
                    Singleton<EventRouter>.GetInstance().BroadCastEvent<uint>("Guild_Refresh_Construct", playerGuildMemberInfo.dwConstruct);
                }
                Singleton<CGuildInfoView>.GetInstance().RefreshSymbolForm(null);
            }
        }
        ...
        public static void ReceiveSetGuildGroupOpenIdNtf(CSPkg msg)
        {
            ...
            if (currentGuildInfo != null)
            {
                ...
                Debug.LogError("Got guildOpenId from server: " + currentGuildInfo.groupOpenId);
            }
        }
        ...
        public static void ReceiveUpgradeGuildByDianQuanRsp(CSPkg msg)
        {
            ...
            {
                Singleton<CUIManager>.GetInstance().OpenTips("Guild_Extend_Member_Limit_Success_Tip", true, 1f, null, new object[0]);
            }
        }
        ...
        private static void RefreshRankpointRankInfoList(enGuildRankpointRankListType rankListType, uint itemNum, CSDT_RANKING_LIST_ITEM_INFO[] itemDetails)
        {
            ...
            Singleton<CGuildModel>.GetInstance().RankpointRankLastGottenTimes[(int) rankListType] = Singleton<CRoleInfoManager>.GetInstance().GetMasterRoleInfo().getCurrentTimeSinceLogin();
            ...
            for (int i = 0; i < itemNum; i++)
            {
                ...
                RankpointRankInfo item = CreateRankpointRankInfo(csdt_ranking_list_item_info);
                view.Add(item);
            }
        }
