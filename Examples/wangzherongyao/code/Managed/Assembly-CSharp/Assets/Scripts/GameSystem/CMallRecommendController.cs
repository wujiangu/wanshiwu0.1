namespace Assets.Scripts.GameSystem
{
    ...
    public class CMallRecommendController : Singleton<CMallRecommendController>
    {
        ...
        public void Draw(CUIFormScript form)
        {
            ...
            Singleton<EventRouter>.GetInstance().AddEventHandler(EventID.Mall_Recommend_Recommend_Data_Refresh, new Action(this, (IntPtr) this.RefreshRecommendView));
            ...
            Singleton<EventRouter>.instance.AddEventHandler(EventID.BAG_ITEMS_UPDATE, new Action(this, (IntPtr) this.OnItemAdd));
            this.InitElements();
        ...
        public static uint GetCurrencyValueFromRoleInfo(CRoleInfo roleInfo, enExchangeType exchangeType)
        {
            ...
            {
                ResGlobalInfo info = GameDataMgr.globalInfoDatabin.GetDataByKey(0x86);
        ...
        public string GetExchangeTypeIconPath(enExchangeType type)
        {
            ...
            switch (type)
            {
                ...
                {
                    dataByKey = GameDataMgr.globalInfoDatabin.GetDataByKey(0x87);
                    DebugHelper.Assert(dataByKey != null, "global cfg databin err: skin exchange id doesnt exist");
                    if (dataByKey == null)
                    {
                        return null;
        ...
        private void InitListTab()
        {
            ...
            if (form != null)
            {
                ...
                {
                    Singleton<CUIManager>.GetInstance().OpenTips("list err", false, 1f, null, new object[0]);
        ...
        {
            Singleton<CMallSystem>.GetInstance().LoadUIPrefab("UGUI/Form/System/Mall/Recommend", "pnlRecommend", form.GetWidget(3), form);
        }
        ...
        private void OnLotteryBuy(CUIEvent uiEvent)
        {
            if ((Singleton<CMallSystem>.GetInstance().m_MallForm != null) && Singleton<CMallSystem>.GetInstance().m_IsMallFormOpen)
            {
                ...
                {
                    case Tab.Hero:
                        CMallSystem.TryToPay(enPayPurpose.RecommendLottery, string.Empty, CMallSystem.ResBuyTypeToPayType(this.m_CurrentLottryCtrl[1].bCostType), this.m_CurrentLottryCtrl[1].dwCostPrice, enUIEventID.Mall_Recommend_On_Lottery_Buy_Confirm, ref uiEvent.m_eventParams, enUIEventID.None, false, true);
                        break;

                    case Tab.Skin:
                        CMallSystem.TryToPay(enPayPurpose.RecommendLottery, string.Empty, CMallSystem.ResBuyTypeToPayType(this.m_CurrentLottryCtrl[2].bCostType), this.m_CurrentLottryCtrl[2].dwCostPrice, enUIEventID.Mall_Recommend_On_Lottery_Buy_Confirm, ref uiEvent.m_eventParams, enUIEventID.None, false, true);
                        break;
                }
            }
        }
        ...
        private void OnMallTabChange()
        {
            ...
            if ((mallForm != null) && Singleton<CMallSystem>.GetInstance().m_IsMallFormOpen)
            {
                ...
                Singleton<EventRouter>.GetInstance().RemoveEventHandler(EventID.Mall_Recommend_Recommend_Data_Refresh, new Action(this, (IntPtr) this.RefreshRecommendView));
                ...
                Singleton<EventRouter>.instance.RemoveEventHandler(EventID.BAG_ITEMS_UPDATE, new Action(this, (IntPtr) this.OnItemAdd));
                this.Clear();
        ...
        private void OnRecommendBuy(CUIEvent uiEvent)
        {
            ...
            switch (this.CurTab)
            {
                case Tab.Hero:
                {
                    ...
                    CMallSystem.TryToPay(enPayPurpose.Buy, StringHelper.UTF8BytesToString(ref dataByKey.szName), tag, payValue, enUIEventID.Mall_Recommend_On_Buy_Confirm, ref uiEvent.m_eventParams, enUIEventID.None, true, true);
                    break;
                }
                case Tab.Skin:
                {
                    ...
                    CMallSystem.TryToPay(enPayPurpose.Buy, StringHelper.UTF8BytesToString(ref heroSkin.szSkinName), tag, payValue, enUIEventID.Mall_Recommend_On_Buy_Confirm, ref uiEvent.m_eventParams, enUIEventID.None, true, true);
                    break;
                }
            }
        ...
        private void OnRecommendListHeroEnable(CUIEvent uiEvent)
        {
            ...
            if (((srcFormScript != null) && (srcWidget != null)) && ((srcWidgetIndexInBelongedList >= 0) && (srcWidgetIndexInBelongedList < this.m_CurrentRecommendHeros.Count)))
            {
                ...
                if ((info.bIsBuyItem == 0) || (info.dwBuyItemCnt == 0))
                {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            CUICommonSystem.SetHeroJob(srcFormScript, gameObject, (enHeroJobType) info.bJob);
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        if ((componetInChild != null) && (text3 != null))
                                        {
                                            ...
                                            text3.text = info.dwBuyItemCnt.ToString();
                                            transform3.gameObject.CustomSetActive(true);
                                            ...
                                            stUIEventParams params2 = new stUIEventParams {
                                                tag = 1,
                                                commonUInt32Param1 = info.dwBuyItemCnt
                                            };
        ...
        private void OnRecommendListSkinEnable(CUIEvent uiEvent)
        {
            ...
            if (((srcFormScript != null) && (srcWidget != null)) && ((srcWidgetIndexInBelongedList >= 0) && (srcWidgetIndexInBelongedList < this.m_CurrentRecommendSkins.Count)))
            {
                ...
                if ((skin.bIsBuyItem == 0) || (skin.dwBuyItemCnt == 0))
                {
                                    ...
                                    else
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if ((componetInChild != null) && (text4 != null))
                                            {
                                                ...
                                                text4.text = skin.dwBuyItemCnt.ToString();
                                                script3.enabled = true;
                                                transform4.gameObject.CustomSetActive(true);
                                                ...
                                                stUIEventParams params2 = new stUIEventParams {
                                                    tag = 2,
                                                    commonUInt32Param1 = skin.dwBuyItemCnt
                                                };
        ...
        public static void ReceiveLotteryRsp(CSPkg msg)
        {
            ...
            {
                Singleton<CUIManager>.GetInstance().OpenTips(Utility.ProtErrCodeToStr(0x49a, msg.stPkgData.stRandDrawRsp.iResult), false, 1f, null, new object[0]);
            }
            else
            {
                ...
                if (GameDataMgr.recommendLotteryCtrlDict.TryGetValue(msg.stPkgData.stRandDrawRsp.dwDrawID, out info))
                {
                    ...
                    {
                        ListView<CUseable> source = new ListView<CUseable>();
                        ...
                        {
                            source.Add(item);
                            Singleton<CUIManager>.GetInstance().OpenAwardTip(source.ToArray<CUseable>(), Singleton<CTextManager>.GetInstance().GetText("gotAward"), false, enUIEventID.None, false, false, "Form_Award");
                            Singleton<CMallRouletteController>.GetInstance().ShowHeroSkin(source);
                        }
                    }
                }
                else
        ...
        public static void ReceiveRecommendBuyRsp(CSPkg msg)
        {
            ...
            {
                Singleton<CUIManager>.GetInstance().OpenTips(Utility.ProtErrCodeToStr(0x498, msg.stPkgData.stSaleRecmdBuyRsp.iResult), false, 1f, null, new object[0]);
            }
            else
            {
                ...
                if (GameDataMgr.recommendProductDict.TryGetValue(dwRcmdID, out recommend) && (recommend.wSaleType == 4))
                {
                    ...
                    {
                        Singleton<CUIManager>.GetInstance().OpenTips(string.Format("heroCfg databin error, Hero ID:{0} not found", recommend.dwSaleID), false, 1f, null, new object[0]);
                    }
                }
            }
        }
        ...
        private void RefreshHeroPricePnl(ResHeroCfgInfo heroCfg)
        {
            ...
            if ((mallForm != null) && Singleton<CMallSystem>.GetInstance().m_IsMallFormOpen)
            {
                ...
                else
                {
                    ...
                    if (obj5 != null)
                    {
                        uint exchangeValue = (heroCfg.bIsBuyItem <= 0) ? 0 : heroCfg.dwBuyItemCnt;
        ...
        {
            <RefreshRecommendListPnl>c__AnonStorey4A storeya = new <RefreshRecommendListPnl>c__AnonStorey4A();
            CUIFormScript form = Singleton<CUIManager>.GetInstance().GetForm(sMallHeroExchangeListPath);
            if (form != null)
            {
                storeya.role = Singleton<CRoleInfoManager>.GetInstance().GetMasterRoleInfo();
                DebugHelper.Assert(storeya.role != null, "master roleInfo is null");
                if (storeya.role != null)
                {
                    switch (this.CurListTab)
                    {
                        case ListTab.Hero:
                            this.m_CurrentRecommendHeros.Sort(new Comparison<ResHeroCfgInfo>(storeya.<>m__49));
                            this.RefreshRecommendList(enExchangeType.HeroExchangeCoupons);
                            this.UpdateExchangeCouponsInfo(form, form.transform.Find("Panel/pnlTotalMoney"), enExchangeType.HeroExchangeCoupons);
                            break;

                        case ListTab.Skin:
                            this.m_CurrentRecommendSkins.Sort(new Comparison<ResHeroSkin>(storeya.<>m__4A));
                    ...
                    if (data != null)
                    {
                        ...
                        for (int i = 0; i < (skillArr.Length - 1); i++)
                        {
                            ...
                            if (gameObject != null)
                            {
                                ...
                                CUIUtility.SetImageSprite(obj4.GetComponent<Image>(), prefabPath, elemenet.m_belongedFormScript, false, true, true);
                                obj4.CustomSetActive(true);
                                stUIEventParams eventParams = new stUIEventParams();
        ...
        private void RefreshSkinBaseInfo(ResHeroSkin skinCfg)
        {
            ...
            if ((mallForm != null) && Singleton<CMallSystem>.GetInstance().m_IsMallFormOpen)
            {
                GameObject obj2 = Utility.FindChild(mallForm.gameObject, "pnlBodyBg/pnlRecommend/heroInfo/heroInfoPanel");
                if (obj2 != null)
                {
                    Text component = obj2.transform.Find("heroNameText").GetComponent<Text>();
                    Text text2 = obj2.transform.Find("heroTitleText").GetComponent<Text>();
                    GameObject gameObject = obj2.transform.Find("jobImage").gameObject;
            ...
            if ((mallForm != null) && Singleton<CMallSystem>.GetInstance().m_IsMallFormOpen)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (obj5 != null)
                        {
                            uint exchangeValue = (skinCfg.bIsBuyItem <= 0) ? 0 : skinCfg.dwBuyItemCnt;
                            Transform transform2 = obj5.transform.Find("BuyButton");
        ...
        private void RefreshTimerView(Transform pnlRefreshTrans)
        {
            if (pnlRefreshTrans != null)
            {
                ...
                if (masterRoleInfo == null)
                {
                    Debug.LogError("Master role info is NULL!");
                }
                else
                {
                    uint num = (uint) masterRoleInfo.getCurrentTimeSinceLogin();
                    CUITimerScript componetInChild = Utility.GetComponetInChild<CUITimerScript>(pnlRefreshTrans.gameObject, "refreshTimer");
                    int num2 = this.m_MostRecentRecommendRefreshTime - ((int) num);
        ...
        private bool SetCurrentLotteryCtrl(uint drawID = 0)
        {
            ...
            ResRandDrawInfo info2 = new ResRandDrawInfo();
            if (((drawID != 0) && GameDataMgr.recommendLotteryCtrlDict.TryGetValue(drawID, out info2)) && ((info2.bDrawType >= 1) && (info2.bDrawType < 3)))
            {
                this.m_CurrentLottryCtrl[info2.bDrawType] = info2;
            }
            DictionaryView<uint, ResRandDrawInfo>.Enumerator enumerator = GameDataMgr.recommendLotteryCtrlDict.GetEnumerator();
            int num3 = 1;
            uint num4 = (uint) masterRoleInfo.getCurrentTimeSinceLogin();
            while (enumerator.MoveNext())
            {
                KeyValuePair<uint, ResRandDrawInfo> current = enumerator.Current;
                ResRandDrawInfo info3 = current.Value;
                byte bDrawType = info3.bDrawType;
                if ((bDrawType < 1) || (info3.bDrawType > 3))
                {
                    DebugHelper.Assert(false, string.Format("recommend random draw config err, draw type{0} invalid!", bDrawType));
                    return false;
                }
                if ((info3.dwEndTimeGen == 0x7fffffff) && (info3.dwStartTimeGen == 0))
                {
                    this.m_DefaultLotteryCtrl[bDrawType] = info3;
                    num3++;
                }
                else
                {
                    uint dwStartTimeGen = info3.dwStartTimeGen;
                    uint dwEndTimeGen = info3.dwEndTimeGen;
                    ...
                    if ((dwStartTimeGen < num4) && (num4 < dwEndTimeGen))
                    {
                        info3.dwStartTimeGen = dwStartTimeGen;
                        info3.dwEndTimeGen = dwEndTimeGen;
                        this.m_CurrentLottryCtrl[bDrawType] = info3;
                    }
                    else if ((dwStartTimeGen > num4) && (dwStartTimeGen < this.m_MostRecentCtrlRefreshTime[bDrawType]))
                    {
            ...
            for (int j = 1; j < num; j++)
            {
                ...
                {
                    Singleton<CUIManager>.GetInstance().OpenTips("Recommend Lottery Ctrl Cfg Err", false, 1f, null, new object[0]);
                    return false;
                }
                ...
                long num9 = (long) ((this.m_MostRecentCtrlRefreshTime[j] - num4) * ((ulong) 0x3e8L));
        ...
        private bool SetCurrentPoolData()
        {
            ...
            for (byte i = 1; i < num; i = (byte) (i + 1))
            {
                ...
                {
                    Singleton<CUIManager>.GetInstance().OpenTips("Recommend Lottery Reward Cfg Err", false, 1f, null, new object[0]);
                    return false;
                }
            }
            return true;
        ...
        private bool SetCurrentRecommendData()
        {
            ...
            int num = 1;
            uint num2 = (uint) masterRoleInfo.getCurrentTimeSinceLogin();
            while (enumerator.MoveNext())
            {
                ...
                if ((dwOnTimeGen < num2) && (num2 < dwOffTimeGen))
                {
                ...
                else if ((dwOnTimeGen > num2) && (dwOnTimeGen < this.m_MostRecentRecommendRefreshTime))
                {
            ...
            {
                Singleton<CUIManager>.GetInstance().OpenTips("Recommend Products Ctrl Cfg Err", false, 1f, null, new object[0]);
                return false;
            }
            ...
            long num5 = (long) ((this.m_MostRecentRecommendRefreshTime - num2) * ((ulong) 0x3e8L));
        ...
        [CompilerGenerated]
        private sealed class <RefreshRecommendListPnl>c__AnonStorey4A
        {
            internal CRoleInfo role;

            internal int <>m__49(ResHeroCfgInfo l, ResHeroCfgInfo r)
            {
                bool flag = false;
                bool flag2 = false;
            ...
            internal int <>m__4A(ResHeroSkin l, ResHeroSkin r)
            {
                bool flag = false;
                bool flag2 = false;
