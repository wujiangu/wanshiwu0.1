namespace Assets.Scripts.GameSystem
{
    ...
    public class BattleMisc
    {
        ...
        public void BindHP()
        {
            ...
            {
                DebugHelper.Assert(false, "invalid host player or host player captain or valuecomponent");
            }
        }
        ...
        public void Init(GameObject node, CUIFormScript formScript)
        {
            ...
            this.animationScript = Singleton<CUIManager>.instance.GetForm(CBattleSystem.s_battleUIForm).GetComponent<CUIAnimatorScript>();
            this.bIn10 = false;
            this.bIn30 = false;
            this.bNormal = true;
            this.bossActorRoot.Release();
