namespace Assets.Scripts.GameSystem
{
    ...
    internal class CBuyCoinPanel : CBuyPanelBase
    {
        ...
        {
            ResCoinBuyInfo dataByKey = GameDataMgr.coninBuyDatabin.GetDataByKey((int) ((ushort) (base.m_CurBuyTime + 1)));
            if (dataByKey != null)
            {
        ...
        protected override uint GetRequireDianquan(int times)
        {
            ...
            {
                wCouponsCost = GameDataMgr.coninBuyDatabin.GetDataByKey((int) ((ushort) ((base.m_CurBuyTime + 1) + i))).wCouponsCost;
