namespace Assets.Scripts.GameSystem
{
    ...
    public class CShopSystem : Singleton<CShopSystem>
    {
        ...
        public string sShopMysteryShopActiveFormPath = "UGUI/Form/System/Shop/Form_Shop_MYSTERY_ACTIVE_TIP.prefab";
        ...
        {
            <GetCost>c__AnonStorey56 storey = new <GetCost>c__AnonStorey56 {
                shopType = shopType,
                refreshCnt = refreshCnt
            };
            return GameDataMgr.shopRefreshCostDatabin.FindIf(new Func<ResShopRefreshCost, bool>(storey, (IntPtr) this.<>m__67));
        }
        ...
        {
            CRoleInfo masterRoleInfo = Singleton<CRoleInfoManager>.instance.GetMasterRoleInfo();
            DateTime time2 = new DateTime(0x7b2, 1, 1, 0, 0, 0, DateTimeKind.Utc).AddSeconds((double) masterRoleInfo.getCurrentTimeSinceLogin());
            ...
            int[] refreshTime = GameDataMgr.shopTypeDatabin.GetDataByKey((int) ((ushort) shopType)).RefreshTime;
            int num = 0;
            int num2 = 0;
        ...
        public override void Init()
        {
            ...
            instance.AddUIEventListener(enUIEventID.Shop_OpenMysteryShop, new CUIEventManager.OnUIEventHandler(this.OnShop_OpenMysteryShopForm));
            instance.AddUIEventListener(enUIEventID.Shop_CloseMysteryShop, new CUIEventManager.OnUIEventHandler(this.OnShop_CloseMysteryShopForm));
            instance.AddUIEventListener(enUIEventID.Shop_RefuseMysteryShop, new CUIEventManager.OnUIEventHandler(this.OnShop_RefuseMysteryShop));
            instance.AddUIEventListener(enUIEventID.Shop_AcceptMysteryShop, new CUIEventManager.OnUIEventHandler(this.OnShop_OpenMysteryShopForm));
            ...
            Singleton<EventRouter>.GetInstance().AddEventHandler(EventID.Shop_Auto_Refresh_Shop_Items, new Action(this, (IntPtr) this.OnRequestAutoRefreshShopItems));
            ...
            Singleton<EventRouter>.instance.AddEventHandler("MasterAttributesChanged", new Action(this, (IntPtr) this.MasterAttrChanged));
        ...
        {
            ResShopType dataByKey = GameDataMgr.shopTypeDatabin.GetDataByKey((int) ((ushort) shopType));
            if (dataByKey == null)
            {
        ...
        private bool NeedAutoRefreshShop(RES_SHOP_TYPE shopType)
        {
            ...
            if (dataByKey != null)
            {
                ...
                CRoleInfo masterRoleInfo = Singleton<CRoleInfoManager>.instance.GetMasterRoleInfo();
                object[] inParameters = new object[] { shopType };
                DebugHelper.Assert(masterRoleInfo != null, "roleinfo loss, NeedAutoRefreshShop, {0}", inParameters);
                if (masterRoleInfo == null)
                {
                    return false;
                }
                DateTime time = new DateTime(0x7b2, 1, 1, 0, 0, 0, DateTimeKind.Utc);
                DateTime time2 = time.AddSeconds((double) masterRoleInfo.getCurrentTimeSinceLogin());
        ...
        private void OnShop_BuyItem(CUIEvent uiEvent)
        {
            ...
            else
            {
                ...
                {
                    case COM_ITEM_TYPE.COM_OBJTYPE_HERO:
                        Singleton<CUIManager>.GetInstance().OpenTips(Singleton<CTextManager>.GetInstance().GetText("hasOwnHero"), false, 1f, null, new object[0]);
                        return;

                    case COM_ITEM_TYPE.COM_OBJTYPE_HEROSKIN:
                        Singleton<CUIManager>.GetInstance().OpenTips(Singleton<CTextManager>.GetInstance().GetText("Hero_SkinBuy_Has_Own"), false, 1f, null, new object[0]);
                        return;
                }
        ...
        private void OnShop_CloseMysteryShopForm(CUIEvent uiEvent)
        {
            if (this.m_IsShopFormOpen)
            {
                Singleton<CUIManager>.GetInstance().CloseForm(this.sMysteryShopFormPath);
        ...
        private void OnShop_OpenMysteryShopForm(CUIEvent uiEvent)
        {
        }
        ...
        public void OnShop_RefuseMysteryShop(CUIEvent uiEvent)
        {
            Singleton<CUIManager>.GetInstance().CloseForm(this.sShopMysteryShopActiveFormPath);
        }
                    ...
                    switch (((Tab) num))
                    {
                        ...
                        case Tab.Pvp_Symbol_Shop:
                            if (!Singleton<CFunctionUnlockSys>.instance.FucIsUnlock(RES_SPECIALFUNCUNLOCK_TYPE.RES_SPECIALFUNCUNLOCKTYPE_SYMBOLSHOP))
                            {
                                ...
                                Singleton<CUIManager>.instance.OpenTips(Utility.UTF8Convert(unlock4.szLockedTip), false, 1f, null, new object[0]);
                                flag = false;
                            }
                            break;
                        ...
                        case Tab.Burning_Exp_Shop:
                            if (!Singleton<CFunctionUnlockSys>.instance.FucIsUnlock(RES_SPECIALFUNCUNLOCK_TYPE.RES_SPECIALFUNCUNLOCKTYPE_LIUGUOYUANZHENG))
                            {
                                ...
                                Singleton<CUIManager>.instance.OpenTips(Utility.UTF8Convert(unlock2.szLockedTip), false, 1f, null, new object[0]);
                                flag = false;
                            }
                            break;
                        ...
                        case Tab.Arena_Shop:
                            if (!Singleton<CFunctionUnlockSys>.instance.FucIsUnlock(RES_SPECIALFUNCUNLOCK_TYPE.RES_SPECIALFUNCUNLOCKTYPE_ARENA))
                            {
                                ...
                                Singleton<CUIManager>.instance.OpenTips(Utility.UTF8Convert(unlock.szLockedTip), false, 1f, null, new object[0]);
                                flag = false;
                            }
                            break;
                        ...
                        case Tab.Guild_Shop:
                            if (!Singleton<CFunctionUnlockSys>.instance.FucIsUnlock(RES_SPECIALFUNCUNLOCK_TYPE.RES_SPECIALFUNCUNLOCKTYPE_GUILDSHOP))
                            {
                                ...
                                Singleton<CUIManager>.instance.OpenTips(Utility.UTF8Convert(unlock5.szLockedTip), false, 1f, null, new object[0]);
                                flag = false;
                            }
                            break;
                    }
        ...
        public static void ReceiveShopItems(CSPkg msg)
        {
            ...
            ResShopType dataByKey = GameDataMgr.shopTypeDatabin.GetDataByKey((int) ((ushort) wShopType));
            if (dataByKey != null)
            {
            ...
            for (byte i = 0; i < stItemList.bItemCnt; i = (byte) (i + 1))
            {
                ...
                instance.GetShopItemPrice(ref info2);
        ...
        private void RefreshBuyPnl()
        {
            ...
            itemUseable = CUseableManager.CreateUseable(info2.enItemType, info2.dwItemId, info2.wItemCnt);
            if (itemUseable == null)
            {
                return;
            }
        ...
        Label_04B6:
            ...
            if (text4 != null)
            {
                text4.text = info2.fPrice.ToString();
            }
            if (text5 != null)
            {
                text5.text = itemUseable.m_description;
            }
            if (info2.enItemType == COM_ITEM_TYPE.COM_OBJTYPE_ITEMPROP)
            {
            ...
            else if (info2.enItemType == COM_ITEM_TYPE.COM_OBJTYPE_ITEMEQUIP)
            {
            ...
            else if (info2.enItemType == COM_ITEM_TYPE.COM_OBJTYPE_ITEMSYMBOL)
            {
            }
            if (text6 != null)
            {
                text6.text = info2.wItemCnt + Singleton<CTextManager>.GetInstance().GetText("Shop_Item_Buy_Status_Unit");
            }
            if (itemCell != null)
            {
        ...
        public void RefreshInfoPanel()
        {
            ...
            switch (this.m_CurShopType)
            {
                ...
                case RES_SHOP_TYPE.RES_SHOPTYPE_MYSTERY:
                {
                    ...
                    int num4 = masterRoleInfo.getCurrentTimeSinceLogin();
                    stShopInfo info2 = new stShopInfo();
                    if (!this.m_Shops.TryGetValue(2, out info2))
                    {
                        obj5.CustomSetActive(false);
                        return;
                    }
                    int num6 = info2.dwItemValidTime - num4;
                    if (num6 < 0)
                    {
                        num6 = 0;
                    }
        ...
        public void RefreshTopBar()
        {
            if (this.m_ShopForm != null)
            {
                ...
                if (widget != null)
                {
                    ...
                    GameObject gameObject = transform.FindChild("ActPoint").gameObject;
                    GameObject obj4 = transform.FindChild("Coin").gameObject;
                    GameObject obj5 = transform.FindChild("Gold").gameObject;
                    GameObject obj6 = transform.FindChild("PvpCoin").gameObject;
                    GameObject obj7 = transform.FindChild("BurningCoin").gameObject;
                    GameObject obj8 = transform.FindChild("ArenaCoin").gameObject;
                    GameObject obj9 = transform.FindChild("GuildConstruct").gameObject;
                    Text component = null;
                    switch (this.m_CurShopType)
                    {
                        case RES_SHOP_TYPE.RES_SHOPTYPE_FIXED:
                        ...
                        case RES_SHOP_TYPE.RES_SHOPTYPE_GUILD_HEAD_IMAGE:
                            ...
                            component = obj9.transform.FindChild("Text").GetComponent<Text>();
                            if (component != null)
                            {
        ...
        private void ResetManualRefreshCountIfNeed()
        {
            ...
            if (this.m_Shops.TryGetValue((uint) this.m_CurShopType, out info))
            {
                ...
                if ((info.dwManualRefreshTime < globalRefreshTimeSeconds) && (globalRefreshTimeSeconds <= num2))
                {
        ...
        public override void UnInit()
        {
            ...
            instance.RemoveUIEventListener(enUIEventID.Shop_OpenMysteryShop, new CUIEventManager.OnUIEventHandler(this.OnShop_OpenMysteryShopForm));
            instance.RemoveUIEventListener(enUIEventID.Shop_CloseMysteryShop, new CUIEventManager.OnUIEventHandler(this.OnShop_CloseMysteryShopForm));
            instance.RemoveUIEventListener(enUIEventID.Shop_RefuseMysteryShop, new CUIEventManager.OnUIEventHandler(this.OnShop_RefuseMysteryShop));
            instance.RemoveUIEventListener(enUIEventID.Shop_AcceptMysteryShop, new CUIEventManager.OnUIEventHandler(this.OnShop_OpenMysteryShopForm));
            ...
            Singleton<EventRouter>.GetInstance().RemoveEventHandler(EventID.Shop_Auto_Refresh_Shop_Items, new Action(this, (IntPtr) this.OnRequestAutoRefreshShopItems));
            ...
            Singleton<EventRouter>.instance.RemoveEventHandler("MasterAttributesChanged", new Action(this, (IntPtr) this.MasterAttrChanged));
            this.m_ShopForm = null;
        }
        ...
        [CompilerGenerated]
        private sealed class <GetCost>c__AnonStorey56
        {
            internal int refreshCnt;
            internal RES_SHOP_TYPE shopType;

            internal bool <>m__67(ResShopRefreshCost x)
            {
