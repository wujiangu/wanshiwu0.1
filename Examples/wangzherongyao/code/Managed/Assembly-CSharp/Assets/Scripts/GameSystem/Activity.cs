    ...
    public abstract class Activity
    {
            ...
            get
            {
                if (this.TimeType == RES_WEAL_TIME_TYPE.RES_WEAL_TIME_TYPE_REGISTER_DAYS)
                {
                    ...
                    if (masterRoleInfo != null)
                    {
                        ...
                        {
                            return ((masterRoleInfo.AccountRegisterTime_ZeroDay + ((long) (((ulong) 0x15180L) * this._config.ullEndTime))) - 1L);
                        }
                        return 0xf45c2700L;
                    }
                }
        ...
        public virtual RES_WEAL_COLORBAR_TYPE FlagType
        {
            get
            {
                ...
                CRoleInfo masterRoleInfo = Singleton<CRoleInfoManager>.GetInstance().GetMasterRoleInfo();
                if (((bColorBar == RES_WEAL_COLORBAR_TYPE.RES_WEAL_COLORBAR_TYPE_NEW) && (this.StartTime > 0L)) && (masterRoleInfo != null))
                {
                    TimeSpan span = (TimeSpan) (Utility.ToUtcTime2Local((long) masterRoleInfo.getCurrentTimeSinceLogin()) - Utility.ToUtcTime2Local(this.StartTime));
