namespace Assets.Scripts.GameSystem
{
    ...
    public class CExperienceCardSystem : Singleton<CExperienceCardSystem>
    {
        ...
        {
            Singleton<EventRouter>.GetInstance().AddEventHandler<uint, int>("HeroExperienceAdd", new Action<uint, int>(this, (IntPtr) this.OnExperienceHeroAdd));
            Singleton<EventRouter>.GetInstance().AddEventHandler<string, uint, uint>("HeroExperienceTimeUpdate", new Action<string, uint, uint>(this, (IntPtr) this.OnHeroExperienceTimeUpdate));
        }
        ...
        public static void OnReceiveUseExpCardNtf(CSPkg msg)
        {
            ...
            {
                case 2:
                    Singleton<CUIManager>.GetInstance().OpenTips("ExpCardError_HeroOwn", true, 1f, null, new object[0]);
                    break;

                case 3:
                    Singleton<CUIManager>.GetInstance().OpenTips("ExpCardError_InsertHero", true, 1f, null, new object[0]);
                    break;

                case 4:
                    Singleton<CUIManager>.GetInstance().OpenTips("ExpCardError_SkinOwn", true, 1f, null, new object[0]);
                    break;

                case 5:
                    Singleton<CUIManager>.GetInstance().OpenTips("ExpCardError_InsertSkin", true, 1f, null, new object[0]);
                    break;

                case 6:
                    Singleton<CUIManager>.GetInstance().OpenTips("ExpCardError_Other", true, 1f, null, new object[0]);
                    break;
            }
        }
