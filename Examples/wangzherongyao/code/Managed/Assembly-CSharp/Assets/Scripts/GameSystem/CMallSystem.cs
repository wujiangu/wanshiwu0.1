namespace Assets.Scripts.GameSystem
{
    ...
    public class CMallSystem : Singleton<CMallSystem>
    {
        ...
        public static stPayInfoSet GetLowestPayInfoSetOfGood(ResHeroSkin resHeroSkin, enPayType payType = 0)
        {
            ...
            {
                set2 = GetPayInfoSetOfGood(false, 0, 0, skinPromotion.bIsBuyCoupons > 0, skinPromotion.dwBuyCoupons, resHeroSkin.dwBuyCoupons, skinPromotion.bIsBuyDiamond > 0, skinPromotion.dwBuyDiamond, resHeroSkin.dwBuyDiamond, 0x2710);
            }
        ...
        {
            return GetPayInfoSetOfGood(resHeroCfgInfo.bIsBuyCoin > 0, (uint) resHeroCfgInfo.dwBuyCoin, resHeroCfgInfo.bIsBuyCoupons > 0, (uint) resHeroCfgInfo.dwBuyCoupons, resHeroCfgInfo.bIsBuyDiamond > 0, (uint) resHeroCfgInfo.dwBuyDiamond, 0x2710);
        }

        public static stPayInfoSet GetPayInfoSetOfGood(ResHeroSkin resHeroSkin)
        {
            return GetPayInfoSetOfGood(false, 0, resHeroSkin.bIsBuyCoupons > 0, resHeroSkin.dwBuyCoupons, resHeroSkin.bIsBuyDiamond > 0, resHeroSkin.dwBuyDiamond, 0x2710);
        }
        ...
        public static stPayInfoSet GetPayInfoSetOfGood(ResHeroCfgInfo resHeroCfgInfo, ResHeroPromotion resPromotion)
        {
            ...
            {
                return GetPayInfoSetOfGood(resPromotion.bIsBuyCoin > 0, resPromotion.dwBuyCoin, (uint) resHeroCfgInfo.dwBuyCoin, resPromotion.bIsBuyCoupons > 0, resPromotion.dwBuyCoupons, (uint) resHeroCfgInfo.dwBuyCoupons, resPromotion.bIsBuyDiamond > 0, resPromotion.dwBuyDiamond, (uint) resHeroCfgInfo.dwBuyDiamond, 0x2710);
            }
            return GetPayInfoSetOfGood(resHeroCfgInfo.bIsBuyCoin > 0, (uint) resHeroCfgInfo.dwBuyCoin, resHeroCfgInfo.bIsBuyCoupons > 0, (uint) resHeroCfgInfo.dwBuyCoupons, resHeroCfgInfo.bIsBuyDiamond > 0, (uint) resHeroCfgInfo.dwBuyDiamond, 0x2710);
        }
        ...
        public static stPayInfoSet GetPayInfoSetOfGood(ResHeroSkin resHeroSkin, ResSkinPromotion resPromotion)
        {
            if (resPromotion != null)
            {
                return GetPayInfoSetOfGood(false, 0, 0, resPromotion.bIsBuyCoupons > 0, resPromotion.dwBuyCoupons, resHeroSkin.dwBuyCoupons, resPromotion.bIsBuyDiamond > 0, resPromotion.dwBuyDiamond, resHeroSkin.dwBuyDiamond, 0x2710);
            }
            return GetPayInfoSetOfGood(false, 0, resHeroSkin.bIsBuyCoupons > 0, resHeroSkin.dwBuyCoupons, resHeroSkin.bIsBuyDiamond > 0, resHeroSkin.dwBuyDiamond, 0x2710);
        }
        ...
        public void LoadUIPrefab(string prefabPath, string prefabName, GameObject container, CUIFormScript formScript)
        {
        ...
        private void OnMallTabChange(CUIEvent uiEvent)
        {
            ...
            {
                Transform transform = this.m_MallForm.transform.Find("pnlBodyBg/pnlBoutique");
                if (transform != null)
                {
                    transform.gameObject.CustomSetActive(false);
                }
                Transform transform2 = this.m_MallForm.transform.Find("pnlBodyBg/pnlRecommend");
                if (transform2 != null)
                {
                    transform2.gameObject.CustomSetActive(false);
                }
                Transform transform3 = this.m_MallForm.transform.Find("pnlBodyBg/pnlFactoryShop");
                if (transform3 != null)
                {
                    transform3.gameObject.CustomSetActive(false);
                }
                Transform transform4 = this.m_MallForm.transform.Find("pnlBodyBg/pnlBuyHero");
                if (transform4 != null)
                {
                    transform4.gameObject.CustomSetActive(false);
                }
                Transform transform5 = this.m_MallForm.transform.Find("pnlBodyBg/pnlBuySkin");
                if (transform5 != null)
                {
                    transform5.gameObject.CustomSetActive(false);
                }
                Transform transform6 = this.m_MallForm.transform.Find("pnlBodyBg/pnlSymbolGift");
                if (transform6 != null)
                {
                    transform6.gameObject.CustomSetActive(false);
                }
                Transform transform7 = this.m_MallForm.transform.Find("pnlBodyBg/pnlRoulette");
                if (transform7 != null)
                {
                    transform7.gameObject.CustomSetActive(false);
                }
                Transform transform8 = this.m_MallForm.transform.Find("pnlBodyBg/pnlMystery");
                if (transform8 != null)
                {
        ...
        public void SetFreeDrawTimer()
        {
            if (Singleton<GameStateCtrl>.instance.GetCurrentState() is LobbyState)
            {
                ...
                if (masterRoleInfo != null)
                {
                    ...
                    {
                        long num3 = Math.Max(0, masterRoleInfo.m_freeDrawInfo[index].dwLeftFreeDrawCD - masterRoleInfo.getCurrentTimeSinceLogin()) * 0x3e8;
                        if (num3 < 0x7fffffffL)
                        {
        ...
        public void SymbolFreeDrawTimerHandler(int seq)
        {
            ...
            {
                int index = 4;
                if ((masterRoleInfo.m_freeDrawInfo[index].dwLeftFreeDrawCnt == 0) && ((masterRoleInfo.m_freeDrawInfo[index].dwLeftFreeDrawCD - masterRoleInfo.getCurrentTimeSinceLogin()) <= 0))
                {
        ...
        public static void TryToPay(enPayPurpose payPurpose, string goodName, enPayType payType, uint payValue, enUIEventID confirmEventID, ref stUIEventParams confirmEventParams, enUIEventID cancelEventID, bool needConfirm, bool guideToAchieveDianQuan)
        {
            ...
            if (masterRoleInfo != null)
            {
                if (GetCurrencyValueFromRoleInfo(masterRoleInfo, payType) >= payValue)
                {
                    ...
                    if (needConfirm)
                    {
                        ...
                        string strContent = string.Format(Singleton<CTextManager>.GetInstance().GetText("ConfirmPay", textArray1), new object[0]);
