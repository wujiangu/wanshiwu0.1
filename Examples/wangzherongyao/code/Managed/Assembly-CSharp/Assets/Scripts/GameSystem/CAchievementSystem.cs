namespace Assets.Scripts.GameSystem
{
    ...
    public class CAchievementSystem : Singleton<CAchievementSystem>
    {
        ...
        public override void Init()
        {
            ...
            Singleton<CUIEventManager>.GetInstance().AddUIEventListener(enUIEventID.Achievement_OpenAwardForm, new CUIEventManager.OnUIEventHandler(this.OnAchievementOpenAwardForm));
