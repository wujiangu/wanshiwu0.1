namespace Assets.Scripts.GameSystem
{
    ...
    public class CFunctionUnlockSys : Singleton<CFunctionUnlockSys>
    {
        ...
        public bool CheckUnlock(uint id)
        {
            ...
            if ((masterRoleInfo != null) && (dataByKey != null))
            {
                switch (dataByKey.wUnlockType)
                {
                    ...
                    case 2:
                    {
                        int key = (int) dataByKey.UnlockParam[0];
                        int num2 = (int) dataByKey.UnlockParam[1];
                        int index = 0;
                        ResLevelCfgInfo info2 = GameDataMgr.levelDatabin.GetDataByKey(key);
                        ...
                        if (((info2 != null) && (info2 != null)) && ((masterRoleInfo.pveLevelDetail[index] != null) && (masterRoleInfo.pveLevelDetail[index].ChapterDetailList[info2.iChapterId - 1] != null)))
                        {
                            ...
                            for (int i = 0; i < pve_chapter_complete_info.LevelDetailList.Length; i++)
                            {
                                ...
                                if ((pve_level_complete_info != null) && (pve_level_complete_info.iLevelID == key))
                                {
        ...
        public override void Init()
        {
            ...
            Singleton<EventRouter>.instance.AddEventHandler("FucUnlockConditionChanged", new Action(this, (IntPtr) this.UnlockConditionChanged));
            base.Init();
        }
        ...
        private void on_checkunlock_time(int timer)
        {
        ...
        public override void UnInit()
        {
            ...
            Singleton<EventRouter>.instance.RemoveEventHandler("FucUnlockConditionChanged", new Action(this, (IntPtr) this.UnlockConditionChanged));
            base.UnInit();
        }
