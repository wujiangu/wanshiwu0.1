namespace Assets.Scripts.GameSystem
{
    ...
    public class CSurrenderSystem : Singleton<CSurrenderSystem>
    {
        ...
        public bool CanSurrender()
        {
            ...
            return ((curLvelContext != null) && curLvelContext.IsPvpGameType());
        }
        ...
        private int GetTotalAcnt()
        {
            ...
            return (curLvelContext.pvpLevelPlayerNum / 2);
        }
        ...
        public bool InSurrenderCD()
        {
            ...
            if (masterRoleInfo != null)
            {
                ...
                if ((this.m_lastSurrenderTime > 0) && (masterRoleInfo.getCurrentTimeSinceLogin() >= (this.m_lastSurrenderTime + this.GetSurrenderCDTime())))
                {
                    return false;
                }
            }
        ...
        public bool InSurrenderCD(out uint time)
        {
            ...
            if (masterRoleInfo != null)
            {
                ...
                if (this.m_lastSurrenderTime > 0)
                {
                    if (masterRoleInfo.getCurrentTimeSinceLogin() >= (this.m_lastSurrenderTime + this.GetSurrenderCDTime()))
                    {
                        return false;
                    }
                    time = (uint) ((this.m_lastSurrenderTime + this.GetSurrenderCDTime()) - masterRoleInfo.getCurrentTimeSinceLogin());
                }
            }
            return true;
        }
        ...
        private bool IsWarmBattle()
        {
            ...
            return curLvelContext.isWarmBattle;
        }
