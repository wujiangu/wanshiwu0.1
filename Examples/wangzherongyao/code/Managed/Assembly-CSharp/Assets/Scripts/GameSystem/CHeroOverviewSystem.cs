namespace Assets.Scripts.GameSystem
{
    ...
    public class CHeroOverviewSystem : Singleton<CHeroOverviewSystem>
    {
        ...
        {
            <SortHeroList>c__AnonStorey3F storeyf = new <SortHeroList>c__AnonStorey3F {
                role = Singleton<CRoleInfoManager>.GetInstance().GetMasterRoleInfo()
            };
            if (storeyf.role != null)
            {
                heroList.Sort(new Comparison<IHeroData>(storeyf.<>m__35));
            }
        }
        ...
        [CompilerGenerated]
        private sealed class <SortHeroList>c__AnonStorey3F
        {
            internal CRoleInfo role;

            internal int <>m__35(IHeroData heroData1, IHeroData heroData2)
            {
