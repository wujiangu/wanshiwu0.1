namespace Assets.Scripts.GameSystem
{
    ...
    public class CTrainingHelper : Singleton<CTrainingHelper>
    {
        ...
        private void DoCheatAction(ECheatAct inAct, EActTarget inTar, int inParam)
        {
            ...
            switch (inAct)
            {
                ...
                case ECheatAct.AddGold:
                {
                    ...
                    bool flag2 = (context2 != null) && context2.isPVPLevel;
                    ...
                    {
                        player3.Captain.handle.ValueComponent.ChangeGoldCoinInBattle(0x3e8, true, true, new Vector3());
                    }
                    break;
                }
        ...
        private void OnTrainingHelperClose(CUIEvent uiEvent)
        {
            ...
            if (this.m_form != null)
            {
                Transform transform = this.m_form.transform.FindChild("panelTopLeft");
                if (transform != null)
                {
        ...
        private void OnTrainingHelperInit(CUIEvent uiEvent)
        {
            if (this.m_form == null)
            {
                this.m_form = Singleton<CBattleSystem>.instance.m_FormScript;
