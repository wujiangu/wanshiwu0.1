namespace Assets.Scripts.GameSystem
{
    ...
    public class CPaySystem : Singleton<CPaySystem>
    {
        ...
        public override void Init()
        {
            ...
            Singleton<EventRouter>.GetInstance().AddEventHandler(EventID.ApolloHelper_Pay_Success, new Action(this, (IntPtr) this.OnPaySuccess));
            Singleton<EventRouter>.GetInstance().AddEventHandler<int>(EventID.ApolloHelper_Pay_Risk_Hit, new Action<int>(this.OnPayRiskHit));
            Singleton<EventRouter>.GetInstance().AddEventHandler(EventID.ApolloHelper_Pay_Failed, new Action(this, (IntPtr) this.OnPayFailed));
            Singleton<EventRouter>.GetInstance().AddEventHandler(EventID.ApolloHelper_Need_Login, new Action(this, (IntPtr) this.OnNeedLogin));
        ...
        private void NeedUpdateChaoZhieGift(CMallFactoryShopController.ShopProduct product)
        {
            ...
            if (((product2 == null) || !product2.IsOnSale) && ((product3 == null) || !product3.IsOnSale))
            {
                CRoleInfo masterRoleInfo = Singleton<CRoleInfoManager>.GetInstance().GetMasterRoleInfo();
        ...
        private void OnClickDianQuanGift(CUIEvent uiEvent)
        {
            ...
            if (masterRoleInfo != null)
            {
                ...
                {
                    Singleton<CUIManager>.GetInstance().OpenTips("充值超过钻石上限", false, 1f, null, new object[0]);
                }
                else
                {
        ...
        {
            Singleton<CUIManager>.GetInstance().OpenTips("Common_Need_Login", true, 1f, null, new object[0]);
        ...
        private void OnPayFailed()
        {
            ...
            Singleton<CUIManager>.GetInstance().OpenTips("Err_Common_Pay_Failed", true, 1f, null, new object[0]);
        }
        ...
        private void OnPaySuccess()
        {
            ...
            SendReqQueryAcntDianQuan(payType);
        ...
        public void OpenBuyDianQuanPanel()
        {
            ...
            {
                Singleton<CChatController>.GetInstance().ShowPanel(true, false);
                if (Singleton<CUIManager>.GetInstance().OpenForm(s_buyDianQuanFormPath, false, true) != null)
                {
        ...
        private void RefreshFirstPayPanel()
        {
            ...
            if (form != null)
            {
                ...
                ResRandomRewardStore dataByKey = GameDataMgr.randowmRewardDB.GetDataByKey(dwConfValue);
        ...
        public override void UnInit()
        {
            ...
            Singleton<EventRouter>.GetInstance().RemoveEventHandler(EventID.ApolloHelper_Pay_Success, new Action(this, (IntPtr) this.OnPaySuccess));
            ...
            Singleton<EventRouter>.GetInstance().RemoveEventHandler(EventID.ApolloHelper_Pay_Failed, new Action(this, (IntPtr) this.OnPayFailed));
            Singleton<EventRouter>.GetInstance().RemoveEventHandler(EventID.ApolloHelper_Need_Login, new Action(this, (IntPtr) this.OnNeedLogin));
