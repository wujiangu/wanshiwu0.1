namespace Assets.Scripts.GameSystem
{
    ...
    public class PVEReviveHeros : Singleton<PVEReviveHeros>
    {
        ...
        private bool IsCareCondition()
        {
            ...
            SLevelContext curLvelContext = Singleton<BattleLogic>.GetInstance().GetCurLvelContext();
            return (!curLvelContext.isPVPMode && (curLvelContext.GameType == COM_GAME_TYPE.COM_SINGLE_GAME_OF_ADVENTURE));
        }
        ...
        {
            Singleton<FrameSynchr>.instance.bEscape = bPause;
            Singleton<CBattleSystem>.instance.m_isInBattle = !bPause;
        }
