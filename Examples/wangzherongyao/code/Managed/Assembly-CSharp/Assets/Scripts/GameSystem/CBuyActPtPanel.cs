namespace Assets.Scripts.GameSystem
{
    ...
    internal class CBuyActPtPanel : CBuyPanelBase
    {
        ...
        protected override uint GetRequireDianquan(int times)
        {
            ...
            {
                dwCoinPrice = GameDataMgr.resShopInfoDatabin.GetDataByKey((int) ((ushort) (((400 + base.m_CurBuyTime) + 1) + i))).dwCoinPrice;
        ...
        protected bool willOverMaxAP(int times)
        {
            ...
            for (int i = 0; i < times; i++)
            {
                num += (int) GameDataMgr.resShopInfoDatabin.GetDataByKey((int) ((ushort) ((400 + base.m_CurBuyTime) + 1))).dwValue;
            }
