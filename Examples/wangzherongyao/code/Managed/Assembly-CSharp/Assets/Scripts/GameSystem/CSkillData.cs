namespace Assets.Scripts.GameSystem
{
    ...
    public class CSkillData
    {
        ...
        public static int CalcEscapeValue(string escapeString, CHeroInfo heroInfo, int skillLevel)
        {
            char ch;
        ...
        public static int CalcEscapeValue(string escapeString, ValueDataInfo[] valueData, int skillLevel)
        {
            char ch;
            string str = string.Empty;
            str2 = string.Empty;
        ...
        public unsafe stSkillData CreateSkillData(int slotId)
        {
            ...
            data.cfgInfo = GameDataMgr.skillDatabin.GetDataByKey(this.skillIdArr[slotId]);
        ...
        public string GetSkillDesc(int slotId)
        {
            ...
            if (escapeString != null)
            {
                ...
                {
                    skillDesc = skillDesc.Replace("[" + escapeString[i] + "]", CalcEscapeValue(escapeString[i], info2, this.GetSkillLevel(slotId)).ToString());
                }
            }
            return skillDesc;
        }
