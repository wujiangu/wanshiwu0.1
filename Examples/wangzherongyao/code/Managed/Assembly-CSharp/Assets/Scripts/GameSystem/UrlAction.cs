                ...
                case Action.buy:
                    switch (this.prodType)
                    {
                        ...
                        case COM_ITEM_TYPE.COM_OBJTYPE_HERO:
                        {
                            ...
                            {
                                Singleton<CUIManager>.GetInstance().OpenTips("internalError", false, 1f, null, new object[0]);
                                return false;
                            }
                            if (masterRoleInfo.IsHaveHero(this.prodID, false))
                            {
                                Singleton<CUIManager>.GetInstance().OpenTips("hasOwnHero", true, 1f, null, new object[0]);
                                return false;
                            }
                        ...
                        case COM_ITEM_TYPE.COM_OBJTYPE_HEROSKIN:
                        {
                            ...
                            {
                                Singleton<CUIManager>.GetInstance().OpenTips("Skin_NeedToBuyAHero", true, 1f, null, new object[0]);
                                return false;
                            }
                            if (info2.IsHaveHeroSkin(this.prodID, (uint) this.prodSpec, false))
                            {
                                Singleton<CUIManager>.GetInstance().OpenTips("hasOwnHeroSkin", true, 1f, null, new object[0]);
                                return false;
                            }
                    ...
                    if (strArray2.Length > 0)
                    {
                        ...
                        if (view2.ContainsKey("action"))
                        {
                            ...
                            if (key != null)
                            {
                                ...
                                if (<>f__switch$map0.TryGetValue(key, out num3))
                                {
                                    switch (num3)
                                    {
                                        case 0:
