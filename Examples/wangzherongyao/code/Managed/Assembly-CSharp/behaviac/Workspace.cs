namespace behaviac
{
    ...
    public static class Workspace
    {
        ...
        {
            <IsRegisterd>c__AnonStorey57 storey = new <IsRegisterd>c__AnonStorey57 {
                type = type
            };
            return (ms_agentTypes.FindIndex(new Predicate<TypeInfo_t>(storey.<>m__6B)) != -1);
        }
        ...
        private static void RegisterMetas(Assembly a)
        {
            ...
            <RegisterMetas>c__AnonStorey58 storey = new <RegisterMetas>c__AnonStorey58();
            using (ListView<System.Type>.Enumerator enumerator = view.GetEnumerator())
            {
                while (enumerator.MoveNext())
                {
                    storey.type = enumerator.Current;
                    if (!IsRegisterd(storey.type) && (ms_agentTypes.Find(new Predicate<TypeInfo_t>(storey.<>m__6C)) == null))
                    {
        ...
        [CompilerGenerated]
        private sealed class <IsRegisterd>c__AnonStorey57
        {
            internal System.Type type;

            internal bool <>m__6B(Workspace.TypeInfo_t t)
            {
        ...
        [CompilerGenerated]
        private sealed class <RegisterMetas>c__AnonStorey58
        {
            internal System.Type type;

            internal bool <>m__6C(Workspace.TypeInfo_t t)
            {
                return (t.type == this.type);
            }
        }
