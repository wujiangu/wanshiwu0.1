...
[ArgumentDescription(1, typeof(int), "熟练度经验值", new object[] {  }), ArgumentDescription(0, typeof(int), "ID", new object[] {  }), CheatCommand("英雄/属性/AddHeroProficiency", "增加英雄熟练度经验值", 0x31)]
