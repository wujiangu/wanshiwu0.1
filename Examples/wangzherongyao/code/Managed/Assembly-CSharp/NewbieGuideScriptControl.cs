...
public class NewbieGuideScriptControl : MonoBehaviour
{
    ...
    public void CheckSriptComplete(NewbieGuideScriptType type, uint[] param)
    {
        if (null != this.mCurrentScript)
        {
            this.mCurrentScript.CheckComplete(type, param);
        }
    }
