...
public class SceneMgr : MonoSingleton<SceneMgr>
{
    ...
    private int[][] LIMIT_CONFIG = new int[2][];
    ...
    public SceneMgr()
    {
        ...
        this.commonEffects = new object[] { "Prefab_Skill_Effects/tongyong_effects/Indicator/lockt_01", 3, "Prefab_Skill_Effects/tongyong_effects/Siwang_tongyong/siwang_tongyong_01", 5, "prefab_skill_effects/tongyong_effects/tongyong_hurt/huicheng_tongyong_01", 5, "prefab_skill_effects/common_effects/jiasu_tongyong_01", 8 };
    }
    ...
    {
        int num = !isParticle ? GameSettings.ModelLOD : GameSettings.ParticleLOD;
        ...
        for (num = this.GetDynamicLod(num, isParticle); num >= 0; num--)
        {
            string str = path;
            string str2 = lod_postfix[num];
    ...
    {
        return new <UnloadAssets_Coroutine>c__Iterator6();
    }

    [CompilerGenerated]
    private sealed class <UnloadAssets_Coroutine>c__Iterator6 : IDisposable, IEnumerator, IEnumerator<object>
    {
