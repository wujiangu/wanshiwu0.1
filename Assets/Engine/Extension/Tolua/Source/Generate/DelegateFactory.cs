...
public class DelegateFactory
{
	...
	public static void Register()
	{
		...
		dict.Add(typeof(UnityEngine.Events.UnityAction<cs.Event>), factory.UnityEngine_Events_UnityAction_cs_Event);
		...
		DelegateTraits<UnityEngine.Events.UnityAction<cs.Event>>.Init(factory.UnityEngine_Events_UnityAction_cs_Event);
		...
		TypeTraits<UnityEngine.Events.UnityAction<cs.Event>>.Init(factory.Check_UnityEngine_Events_UnityAction_cs_Event);
		...
		StackTraits<UnityEngine.Events.UnityAction<cs.Event>>.Push = factory.Push_UnityEngine_Events_UnityAction_cs_Event;
	...
	class UnityEngine_Events_UnityAction_cs_Event_Event : LuaDelegate
	{
		public UnityEngine_Events_UnityAction_cs_Event_Event(LuaFunction func) : base(func) { }
		public UnityEngine_Events_UnityAction_cs_Event_Event(LuaFunction func, LuaTable self) : base(func, self) { }

		public void Call(cs.Event param0)
		{
			func.BeginPCall();
		...
		public void CallWithSelf(cs.Event param0)
		{
			func.BeginPCall();
			func.Push(self);
			func.PushObject(param0);
	...
	public UnityEngine.Events.UnityAction<cs.Event> UnityEngine_Events_UnityAction_cs_Event(LuaFunction func, LuaTable self, bool flag)
	{
		if (func == null)
		{
			UnityEngine.Events.UnityAction<cs.Event> fn = delegate(cs.Event param0) { };
			return fn;
		}

		if(!flag)
		{
			UnityEngine_Events_UnityAction_cs_Event_Event target = new UnityEngine_Events_UnityAction_cs_Event_Event(func);
			UnityEngine.Events.UnityAction<cs.Event> d = target.Call;
			target.method = d.Method;
			return d;
		}
		else
		{
			UnityEngine_Events_UnityAction_cs_Event_Event target = new UnityEngine_Events_UnityAction_cs_Event_Event(func, self);
			UnityEngine.Events.UnityAction<cs.Event> d = target.CallWithSelf;
			target.method = d.Method;
			return d;
		}
	}

	bool Check_UnityEngine_Events_UnityAction_cs_Event(IntPtr L, int pos)
	{
		return TypeChecker.CheckDelegateType(typeof(UnityEngine.Events.UnityAction<cs.Event>), L, pos);
	}

	void Push_UnityEngine_Events_UnityAction_cs_Event(IntPtr L, UnityEngine.Events.UnityAction<cs.Event> o)
	{
		ToLua.Push(L, o);
	}
