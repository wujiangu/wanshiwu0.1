...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		L.BeginModule("cs");
		cs_EventSystemWrap.Register(L);
		cs_GuiManagerWrap.Register(L);
		cs_GuiSceneWrap.Register(L);
		cs_GuiObjectWrap.Register(L);
		cs_GuiControlWrap.Register(L);
		cs_GuiButtonWrap.Register(L);
		cs_GuiImageWrap.Register(L);
		cs_GuiLabelWrap.Register(L);
		cs_GuiParticleSystemWrap.Register(L);
		cs_Singleton_cs_EventSystemWrap.Register(L);
		cs_Singleton_cs_GuiManagerWrap.Register(L);
		L.EndModule();
		...
		L.RegFunction("UnityAction_cs_Event", UnityEngine_Events_UnityAction_cs_Event);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int UnityEngine_Events_UnityAction_cs_Event(IntPtr L)
	{
		try
		{
			int count = LuaDLL.lua_gettop(L);
			...
			if (count == 1)
			{
				Delegate arg1 = DelegateTraits<UnityEngine.Events.UnityAction<cs.Event>>.Create(func);
				ToLua.Push(L, arg1);
			}
			else
			{
				LuaTable self = ToLua.CheckLuaTable(L, 2);
				Delegate arg1 = DelegateTraits<UnityEngine.Events.UnityAction<cs.Event>>.Create(func, self);
				ToLua.Push(L, arg1);
			}
			return 1;
		}
