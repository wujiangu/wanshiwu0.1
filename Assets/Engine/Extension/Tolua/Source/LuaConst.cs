...
{
    public static string luaDir = Application.dataPath + "/Engine/Extension/Tolua/Lua";                //lua逻辑代码目录
    public static string toluaDir = Application.dataPath + "/Engine/Extension/Tolua/ToLua/Lua";        //tolua lua文件目录
